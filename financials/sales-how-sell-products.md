---
title: 'Procedura: Vendere prodotti | Documenti Microsoft'
description: Descrive come utilizzare gli ordini di vendita.
...
Gli articoli possono essere sia articoli di magazzino che servizi di assistenza, in base ai tipi **Articolo - Magazzino** e **Articolo - Assistenza** nelle righe di vendita. Il processo dell'ordine di vendita è lo stesso per entrambi i tipi di articoli. Per ulteriori informazioni, vedere [Procedura: Registrare nuovi articoli](inventory-how-register-new-items.md).
