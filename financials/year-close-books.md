---
title: Chiusura registri | Documenti Microsoft
description: Vengono illustrati i processi coinvolti nella chiusura dei libri di un anno o un periodo fiscale.
...
---
# <a name="closing-books"></a>Chiusura registri
