...
In caso di domande su [!INCLUDE[d365fin](includes/d365fin_md.md)] per cui non è possibile trovare risposta in questa documentazione, è possibile rivolgersi alla community di Finance and Operations, Business edition. Per ulteriori informazioni, vedere [Community di Dynamics 365 for Finance and Operations, Business edition](https://community.dynamics.com/business). Anche il nostro team del supporto pubblica suggerimenti e consigli. Per ulteriori informazioni, vedere [Blog del supporto di Dynamics 365 for Finance and Operations, Business edition](https://blogs.msdn.microsoft.com/dyn365finsupport).  
