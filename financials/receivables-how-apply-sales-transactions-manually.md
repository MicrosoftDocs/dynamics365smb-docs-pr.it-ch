---
title: 'Procedura: Riconciliare manualmente i pagamenti dei clienti | Documenti Microsoft'
description: 'Procedura: Riconciliare manualmente i pagamenti dei clienti'
...
**Nota**: nella finestra **Movimenti contabili clienti** il carattere rosso indica che il pagamento correlato ha luogo dopo la data di scadenza.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Registrazioni incassi**, quindi scegliere il collegamento correlato.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Registrazioni incassi** e scegliere il collegamento correlato.
2. Scegliere l'azione **Modifica registrazione**.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Note credito vendita**, quindi scegliere il collegamento correlato.
...
9. Per visualizzare i movimenti contabili, nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Clienti** e scegliere il collegamento correlato. Spostarsi sulla scheda del cliente per visualizzare i movimenti contabili.  
