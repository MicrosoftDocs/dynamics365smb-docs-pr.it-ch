---
title: 'Procedura: Utilizzare i fogli presenza per le commesse | Documenti Microsoft'
description: Viene descritto come utilizzare i fogli presenze per gestire progetti.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Fogli presenze**, quindi scegliere il collegamento correlato.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Fogli presenze manager**, quindi scegliere il collegamento correlato.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Fogli presenze manager** o **Fogli presenze**, quindi scegliere il collegamento correlato.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Registraz. risorse**, quindi scegliere il collegamento correlato.  
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Sposta fogli presenze in archivio**, quindi scegliere il collegamento correlato.  
2. Compilare i campi in base alle esigenze, quindi scegliere **OK**.  
3. Per esaminare i fogli presenze archiviati, nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Archivi foglio presenze** o **Archivi foglio presenze manager**, quindi scegliere il collegamento correlato.
