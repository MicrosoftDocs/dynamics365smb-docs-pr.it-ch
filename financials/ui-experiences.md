...
> [!NOTE]  
> Con l'opzione Sandbox, è possibile selezionare l'esperienza **Avanzata**, che fornisce accesso a tutte le funzionalità aziendali possibili, incluse Manufacturing e Gestione assistenza.. Per ulteriori informazioni, vedere [Creare un ambiente sandbox](across-how-create-sandbox-environment.md).
