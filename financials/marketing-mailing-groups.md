...
description: Vengono descritti i gruppi mailing per i contatti in Financials
...
## <a name="defining-mailing-group-codes"></a>Definizione di codici di gruppo di mailing
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Gruppi mailing**, quindi scegliere il collegamento correlato.
