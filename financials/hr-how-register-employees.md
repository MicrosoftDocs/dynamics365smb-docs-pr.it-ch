---
title: 'Procedura: Registrare gli impiegati | Documenti Microsoft'
description: Viene descritto come registrare nuovi impiegati o modificare i dati relativi agli impiegati esistenti.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Dipendenti**, quindi scegliere il collegamento correlato.
...
## <a name="to-register-an-alternate-address-for-an-employee"></a>Per registrare un indirizzo alternativo per un impiegato
