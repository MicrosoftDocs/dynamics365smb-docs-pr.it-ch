---
title: Ricerca della pagina o del report | Documenti Microsoft
description: Informazioni su come utilizzare la ricerca in Dynamics 365 for Financials.
...
**Nota:** le pagine e i report disponibili dipendono dall'interfaccia utente selezionata per la società. L'esperienza **Di base** offre accesso a un numero inferiore di funzionalità rispetto all'esperienza **Suite**. La prima volta che si accede, si utilizza l'esperienza di base. Per ulteriori informazioni, vedere [Personalizzazione dell'esperienza di [!INCLUDE[d365fin](includes/d365fin_long_md.md)]](ui-experiences.md).
