---
title: Utilizzare codici postali di GetAddress.io per il Regno Unito | Documenti Microsoft
description: Fornisce informazioni relative all&quot;estensione dei codici postali di GetAddress.io per il Regno Unito
...
1. In **Indirizzo** scegliere ** Cercare l'indirizzo dal codice postale**.  
    ...
    **NOTA**: l'opzione **Cercare l'indirizzo dal codice postale** è disponibile solo se il campo **Codice paese** è vuoto o contiene **GB**.
...
3. Nella finestra **Selezione Indirizzo** selezionare l'indirizzo.  
    ...
    **SUGGERIMENTO**: se si conosce il numero della via, è possibile filtrare gli indirizzi immettendo il numero completo o parziale nel campo **Punto di consegna**.
