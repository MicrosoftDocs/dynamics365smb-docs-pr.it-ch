---
title: Registrazione automatica delle interazioni con i contatti | Documenti Microsoft
description: Viene descritto come registrare in modo automatico le interazioni con i contatti in Financials
...
Per aprire la finestra **Setup modello interazione**, nell'angolo superiore destro selezionare l'icona **Cerca pagina o report**, ![Cerca pagina o report](media/ui-search/search_small.png "Search for Page or Report icon"), immettere **Setup modello interazione**, quindi selezionare il collegamento correlato.
