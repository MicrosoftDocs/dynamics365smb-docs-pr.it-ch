...
description: Vengono descritti i ruoli professionali per i contatti in Financials
...
## <a name="tp-define-a-job-responsibility-code"></a>Per definire un codice ruolo professionale
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Ruoli professionali**, quindi scegliere il collegamento correlato.
