...
# <a name="the-tax-file-formats-dk-extension-for-finance-and-operations-business-edition"></a>Estensione per formati di file .tax (DK) per Finance and Operations, Business edition
