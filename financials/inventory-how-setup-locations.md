---
title: 'Procedura: Impostare le ubicazioni | Documenti Microsoft'
description: Viene descritto come creare una scheda per ogni ubicazione o warehouse in cui memorizzare gli articoli in magazzino, incluse le regole su come trasferire articoli da e verso ciascuna ubicazione.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Ubicazioni**, quindi scegliere il collegamento correlato.
...
1. Nell'angolo superiore destro scegliere l'icona **Cerca pagina o report** ![Cerca pagina o report](media/ui-search/search_small.png "icona Cerca pagina o report"), inserire **Percorsi trasferimento**, quindi scegliere il collegamento correlato.
