...
description: Scopri come iscriverti e iniziare rapidamente una prova gratuita di Dynamics 365 Business Central. Esplora l'app con presentazioni e video e trova ulteriori risorse di apprendimento.
author: edupont04
...
Il caricamento della versione di valutazione richiederà alcuni istanti, quindi puoi iniziare a utilizzare l'app.

## <a name="what-to-try"></a>Cosa provare

L'ambiente della versione di valutazione include molte delle stesse funzionalità della versione a pagamento. I seguenti collegamenti ti guideranno attraverso l'utilizzo di alcune delle funzionalità chiave.

- [Ulteriori informazioni sulle funzionalità di Business Central](across-business-functionality.md)  
