...
1. Nella Gestione ruolo utente Contabile, scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Setup flusso di cassa**, quindi seleziona il collegamento correlato.
...
6. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Setup flusso di cassa**, quindi seleziona il collegamento correlato.  
