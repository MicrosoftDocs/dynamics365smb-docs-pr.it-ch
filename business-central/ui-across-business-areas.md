...
|Creare task per ricordare le attività da svolgere. È possibile creare task per se stessi, ma è anche possibile assegnarli ad altri utenti o che un'altra persona nell'organizzazione assegni un task all'utente.|[Definire i task dell'utente](across-user-tasks.md)|
...
|In questo articolo viene illustrato come trovare documenti e movimenti correlati tra loro in base a un documento, un contatto o alle informazioni articolo. | [Ricerca di movimenti correlati per i documenti](ui-find-entries.md) |
...
|Imparare a utilizzare le registrazioni generali che vengono utilizzate per la contabilizzazione nei conti di contabilità generale e in altri conti, ad esempio conti correnti bancari, conti clienti e fornitori e conti cespiti. |[Usare le registrazioni COGE](ui-work-general-journals.md) |
...
| Usa le mappe online per trovare posizioni e indicazioni per clienti, fornitori e indirizzi in generale. | [Usare le mappe online per trovare posizioni e indicazioni stradali](across-online-maps.md) |
