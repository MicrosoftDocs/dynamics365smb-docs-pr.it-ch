...
# <a name="record-special-sales-prices-and-discounts" />Registrare i prezzi di vendita e gli sconti speciali
...
## <a name="to-set-up-a-sales-price-for-a-customer" />Per impostare un prezzo di vendita per un cliente
...
## <a name="using-sales-and-purchase-price-lists" />Utilizzo dei listini prezzi di vendita e di acquisto
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update" />Conversione dei prezzi esistenti quando si attiva l'aggiornamento della funzionalità dei prezzi
...
### <a name="editing-active-price-lists" />Modifica dei listini prezzi attivi
...
#### <a name="create-sales-price-lines-based-on-the-unit-price" />Creare righe prezzo di vendita in base al prezzo unitario
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists" />Creare righe prezzo di vendita in base ai listini prezzi esistenti
...
## <a name="to-copy-sales-prices" />Per copiare prezzi di vendita
...
## <a name="to-bulk-update-item-prices" />Per aggiornare in blocco i prezzi degli articoli
...
## <a name="best-price-calculation" />Calcolo del prezzo migliore
...
## <a name="sales-invoice-discounts-and-service-charges" />Sconti fattura di vendita e addebiti assistenza
...
### <a name="calculating-invoice-discounts-on-sales" />Calcolo degli sconti fattura per le vendite

[!INCLUDE [sales-invoice-discounts](includes/sales-invoice-discounts.md)]

## <a name="to-set-up-a-sales-line-discount-for-a-customer" />Per impostare uno sconto riga vendita per un cliente
...
## <a name="to-set-up-an-invoice-discount-for-a-customer" />Per impostare uno sconto fattura per un cliente
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-sales-prices-dynamics-365-business-centralindex" />Vedi il relativo [training Microsoft](/training/modules/manage-sales-prices-dynamics-365-business-central/index)
