...
# <a name="record-special-sales-prices-and-discounts"></a><a name="record-special-sales-prices-and-discounts"></a><a name="record-special-sales-prices-and-discounts"></a>Registrare i prezzi di vendita e gli sconti speciali
...
## <a name="to-set-up-a-sales-price-for-a-customer"></a><a name="to-set-up-a-sales-price-for-a-customer"></a><a name="to-set-up-a-sales-price-for-a-customer"></a>Per impostare un prezzo di vendita per un cliente
...
## <a name="using-sales-and-purchase-price-lists"></a><a name="using-sales-and-purchase-price-lists"></a><a name="using-sales-and-purchase-price-lists"></a>Utilizzo dei listini prezzi di vendita e di acquisto
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update"></a><a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update"></a><a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update"></a>Conversione dei prezzi esistenti quando si attiva l'aggiornamento della funzionalità dei prezzi
...
### <a name="editing-active-price-lists"></a><a name="editing-active-price-lists"></a><a name="editing-active-price-lists"></a>Modifica dei listini prezzi attivi
...
#### <a name="create-sales-price-lines-based-on-the-unit-price"></a><a name="create-sales-price-lines-based-on-the-unit-price"></a><a name="create-sales-price-lines-based-on-the-unit-price"></a>Creare righe prezzo di vendita in base al prezzo unitario
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists"></a><a name="create-sales-price-lines-based-on-existing-price-lists"></a><a name="create-sales-price-lines-based-on-existing-price-lists"></a>Creare righe prezzo di vendita in base ai listini prezzi esistenti
...
## <a name="best-price-calculation"></a><a name="best-price-calculation"></a><a name="best-price-calculation"></a>Calcolo del prezzo migliore
...
## <a name="sales-invoice-discounts-and-service-charges"></a><a name="sales-invoice-discounts-and-service-charges"></a><a name="sales-invoice-discounts-and-service-charges"></a>Sconti fattura di vendita e addebiti assistenza
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/manage-sales-prices-dynamics-365-business-central/index)
