...
|Passaggio|Data di Registrazione|Tipo di movimento|Data di valutazione|Importo costo (previsto)|Importo costo (effettivo)|Nr. movimento cont. articolo|Nr. movimento|  
|----------|------------------|----------------|--------------------|------------------------------|----------------------------|---------------------------|---------------|  
