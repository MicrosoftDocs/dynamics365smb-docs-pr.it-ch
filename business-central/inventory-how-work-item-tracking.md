---
title: 'Tracciare gli articoli con numeri di serie, di lotto e di collo'
...
---
# <a name="track-items-with-serial-lot-and-package-numbers"></a>Tracciare gli articoli con numeri di serie, di lotto e di collo
...
I campi relativi alla quantità nella parte superiore della pagina **Righe tracciabilità articolo** visualizzano le quantità e le somme dei numeri di tracciabilità articolo che vengono definiti nelle righe. Le quantità devono corrispondere a quelle presenti sulle righe del documento, come indicato da *0* nei campi **Non definito** .
...
Se lavori sulla pagina  **Righe di tracciamento articolo** per molto tempo o se sono presenti molte attività con l'articolo su cui stai lavorando, puoi scegliere l'azione  **Aggiorna disponibilità** . Inoltre, la disponibilità dell'articolo viene ricontrollata automaticamente quando viene chiusa la pagina per verificare che non vi siano problemi a riguardo.
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Fatture di acquisto**, quindi seleziona il collegamento correlato.  
...
5. Scegliere il pulsante **OK**. Le informazioni sulla tracciabilità articolo vengono trasferite alla pagina **Righe tracciabilità articolo**.  
...
3. Dalla pagina  **Articolo scheda**, seleziona l'azione  **Correlato**, seleziona l'azione  **Correlato**, seleziona l'azione  **Voci**, quindi seleziona  **Voci del libro mastro**.
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") Icona, immettere **Giornali di riclassificazione degli articoli**, quindi selezionare il relativo collegare.  
...
4. Nel campo  **Numeri di serie** o **Numeri di lotto**, Seleziona il numero di serie o di lotto corrente.  
...
|Righe di tracciamento degli articoli del magazzino     |* Nr. seriale<br><br>* Nuovo nr. seriale<br><br>* Nr. lotto<br><br>* Nuovo nr. lotto<br><br>* Nr. collo<br><br>* Nuovo nr. collo|
|Tracciabilità articolo     |* Filtro nr. seriale<br><br>* Filtro nr. lotto<br><br>* Nr. collo Filtra |
|Registrazione articoli     |* Nr. seriale<br><br>* Nr. lotto<br><br>* Nr. collo     |
