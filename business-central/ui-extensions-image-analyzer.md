...
# Estensione di analisi immagini
...
## Attiva l'estensione Analisi di immagini
...
## Analizzare un'immagine dell'articolo
...
## Analizzare un'immagine di una persona di contatto
...
## Utilizzare il proprio account per l'API Visione artificiale
...
## Visualizzare il numero delle analisi rimanenti per il periodo corrente
...
## Interrompere l'utilizzo dell'estensione di analisi immagini

1. Scegli l'icona a forma di ![lampadina che consente di aprire la funzionalità delle informazioni.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Connessioni servizio**, quindi scegli **Setup analisi immagine**.  
