...
ms.author: edupont
---
# <a name="import-esr-payments-in-the-swiss-version" />Importare pagamenti ESR nella versione per la Svizzera
...
## <a name="to-import-esr-payments" />Per importare pagamenti ESR
