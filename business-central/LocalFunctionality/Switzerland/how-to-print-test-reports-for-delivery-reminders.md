...
ms.author: edupont
---
# <a name="print-test-reports-for-delivery-reminders-in-the-swiss-version"></a><a name="print-test-reports-for-delivery-reminders-in-the-swiss-version"></a>Stampare report di test per i solleciti di consegna nella versione per la Svizzera
...
## <a name="to-print-test-reports-before-issuing-delivery-reminders"></a><a name="to-print-test-reports-before-issuing-delivery-reminders"></a>Per stampare report di test prima di emettere solleciti di consegna
