...
ms.author: edupont
---
# <a name="swiss-electronic-payments-using-esr-in-the-swiss-version"></a><a name="swiss-electronic-payments-using-esr-in-the-swiss-version"></a>Pagamenti elettronici svizzeri tramite ESR nella versione per la Svizzera
