...
ms.author: edupont
---
# <a name="export-payments-using-lsv-in-the-swiss-version"></a><a name="export-payments-using-lsv-in-the-swiss-version"></a>Esportare pagamenti con LSV nella versione per la Svizzera
...
## <a name="to-export-payments-using-lsv"></a><a name="to-export-payments-using-lsv"></a>Per esportare pagamenti tramite LSV
