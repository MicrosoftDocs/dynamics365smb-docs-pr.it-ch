...
ms.author: edupont
---
# <a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version"></a><a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version"></a><a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version"></a>Creare e stampare una dichiarazione IVA svizzera nella versione per la Svizzera
...
## <a name="to-set-up-a-swiss-vat-statement-template"></a><a name="to-set-up-a-swiss-vat-statement-template"></a><a name="to-set-up-a-swiss-vat-statement-template"></a>Per impostare un modello di dichiarazione IVA svizzera
