...
ms.author: edupont
---
# <a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version" />Creare e stampare una dichiarazione IVA svizzera nella versione per la Svizzera
...
## <a name="to-set-up-a-swiss-vat-statement-template" />Per impostare un modello di dichiarazione IVA svizzera
...
## <a name="to-print-the-swiss-vat-statement" />Per stampare la dichiarazione IVA svizzera
