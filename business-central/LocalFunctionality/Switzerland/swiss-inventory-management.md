...
ms.author: edupont
---
# <a name="swiss-inventory-management" />Gestione del magazzino per la Svizzera
...
## <a name="managing-item-details" />Gestione dettagli articolo
...
## <a name="invoices-with-multiple-shipments" />Fatture con più spedizioni
