...
ms.author: edupont
---
# <a name="swiss-inventory-management"></a><a name="swiss-inventory-management"></a>Gestione del magazzino per la Svizzera
...
## <a name="managing-item-details"></a><a name="managing-item-details"></a>Gestione dettagli articolo
...
## <a name="invoices-with-multiple-shipments"></a><a name="invoices-with-multiple-shipments"></a>Fatture con più spedizioni
