...
## <a name="to-print-an-inventory-picking-list-from-a-sales-order"></a><a name="to-print-an-inventory-picking-list-from-a-sales-order"></a><a name="to-print-an-inventory-picking-list-from-a-sales-order"></a>Per stampare una lista prelievi magazzino da un ordine di vendita
