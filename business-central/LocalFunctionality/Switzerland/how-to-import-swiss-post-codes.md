...
ms.author: edupont
---
# <a name="import-swiss-post-codes-in-the-swiss-version" />Importare i numeri postali di avviamento svizzeri nella versione per la Svizzera
...
## <a name="to-import-post-codes" />Per importare i codici postali
...
## <a name="to-define-post-codes-for-customers" />Per definire i codici postali per i clienti
