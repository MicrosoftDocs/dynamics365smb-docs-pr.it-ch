...
ms.author: edupont
---
# <a name="swiss-general-ledger-accounts" />Conti di contabilità generale per la Svizzera
...
## <a name="general-ledger-accounts-and-general-journals" />Conti di contabilità generale e registrazioni COGE
...
## <a name="data-type-for-general-ledger-accounts" />Tipo di dati per i conti C/G
...
## <a name="viewing-temporary-balances-in-general-journals" />Visualizzazione di saldi temporanei nelle registrazioni di contabilità generale
