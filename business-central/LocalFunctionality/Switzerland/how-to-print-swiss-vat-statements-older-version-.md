...
ms.author: edupont
---
# <a name="print-swiss-vat-statements-older-version"></a><a name="print-swiss-vat-statements-older-version"></a>Stampare dichiarazioni IVA svizzere (versione precedente)
