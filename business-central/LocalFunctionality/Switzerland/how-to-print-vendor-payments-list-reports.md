...
ms.author: edupont
---
# <a name="print-vendor-payments-list-reports-in-the-swiss-version" />Stampare report di liste di pagamenti fornitore nella versione per la Svizzera
...
## <a name="to-print-the-vendor-payments-list-report" />Per stampare il report di liste di pagamenti fornitore
