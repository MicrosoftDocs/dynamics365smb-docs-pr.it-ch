...
ms.author: edupont
---
# <a name="adjust-exchange-rates-in-the-swiss-version" />Rettificare i tassi di cambio nella versione per la Svizzera
...
## <a name="to-adjust-an-exchange-rate" />Per rettificare un tasso di cambio
