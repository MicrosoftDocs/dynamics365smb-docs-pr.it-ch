...
ms.author: soalex
---
# <a name="qr-bill-management-in-the-swiss-version-of-business-central"></a><a name="qr-bill-management-in-the-swiss-version-of-business-central"></a>Gestione fatture QR nella versione svizzera di Business Central
...
## <a name="get-started-with-the-qr-bill-management-extension"></a><a name="get-started-with-the-qr-bill-management-extension"></a><a name="get-started"></a>Inizia con l'estensione Gestione fattura QR
...
## <a name="issuing-qr-bills"></a><a name="issuing-qr-bills"></a>Emissione di fatture QR
...
## <a name="adding-billing-information-to-qr-bills"></a><a name="adding-billing-information-to-qr-bills"></a>Aggiunta di informazioni di fatturazione a fatture QR
...
## <a name="understanding-the-payment-reference"></a><a name="understanding-the-payment-reference"></a>Metodi del riferimento del pagamento
...
### <a name="formats-for-qr-references-and-creditor-references"></a><a name="formats-for-qr-references-and-creditor-references"></a><a name="formats"></a>Formati per riferimenti QR e riferimenti creditori
...
## <a name="using-multiple-bank-accounts-as-issuers-of-qr-bills"></a><a name="using-multiple-bank-accounts-as-issuers-of-qr-bills"></a><a name="multiplebankaccounts"></a>Utilizzo di più conti bancari per emettere fatture QR
...
### <a name="adding-a-qr-iban-to-a-new-or-existing-bank-account"></a><a name="adding-a-qr-iban-to-a-new-or-existing-bank-account"></a>Aggiunta di un QR-IBAN a un conto bancario nuovo o esistente
...
## <a name="scanning-and-importing-qr-bills"></a><a name="scanning-and-importing-qr-bills"></a>Scansione ed importazione di fatture QR
...
## <a name="receiving-qr-bills"></a><a name="receiving-qr-bills"></a>Ricezione di fatture QR
...
### <a name="receiving-a-qr-bill-through-an-incoming-document"></a><a name="receiving-a-qr-bill-through-an-incoming-document"></a>Ricezione di una fattura QR tramite un documento in arrivo
...
#### <a name="receiving-through-the-kofax-ocr-service"></a><a name="receiving-through-the-kofax-ocr-service"></a>Ricezione tramite il servizio Kofax OCR
...
### <a name="receiving-a-qr-bill-through-purchase-orders-or-purchase-invoices"></a><a name="receiving-a-qr-bill-through-purchase-orders-or-purchase-invoices"></a>Ricezione di una fattura QR con ordini di acquisto o fatture di acquisto
...
### <a name="receiving-a-qr-bill-through-a-purchase-journal"></a><a name="receiving-a-qr-bill-through-a-purchase-journal"></a>Ricezione di una fattura QR con una giornale di registrazione acquisti
...
## <a name="reconciliation"></a><a name="reconciliation"></a>Riconciliazione
