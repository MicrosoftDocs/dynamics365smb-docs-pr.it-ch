...
## <a name="get-started"></a>Inizia con l'estensione Gestione fattura QR
...
## Aggiunta di informazioni di fatturazione a fatture QR
...
## Metodi del riferimento del pagamento
...
### <a name="formats"></a>Formati per riferimenti QR e riferimenti creditori
...
## <a name="multiplebankaccounts"></a>Utilizzo di più conti bancari per emettere fatture QR
...
### Aggiunta di un QR-IBAN a un conto bancario nuovo o esistente
...
## Scansione ed importazione di fatture QR
...
### Ricezione di una fattura QR tramite un documento in arrivo
...
### Ricezione di una fattura QR con una giornale di registrazione acquisti
