...
ms.author: soalex
---
# <a name="qr-bill-management-in-the-swiss-version-of-business-central" />Gestione fatture QR nella versione svizzera di Business Central
...
## <a name="issuing-qr-bills" />Emissione di fatture QR
...
## <a name="adding-billing-information-to-qr-bills" />Aggiunta di informazioni di fatturazione a fatture QR
...
## <a name="understanding-the-payment-reference" />Metodi del riferimento del pagamento
...
### <a name="adding-a-qr-iban-to-a-new-or-existing-bank-account" />Aggiunta di un QR-IBAN a un conto bancario nuovo o esistente
...
## <a name="scanning-and-importing-qr-bills" />Scansione ed importazione di fatture QR
...
## <a name="receiving-qr-bills" />Ricezione di fatture QR
...
### <a name="receiving-a-qr-bill-through-an-incoming-document" />Ricezione di una fattura QR tramite un documento in arrivo
...
#### <a name="receiving-through-the-kofax-ocr-service" />Ricezione tramite il servizio Kofax OCR
...
### <a name="receiving-a-qr-bill-through-purchase-orders-or-purchase-invoices" />Ricezione di una fattura QR con ordini di acquisto o fatture di acquisto
...
### <a name="receiving-a-qr-bill-through-a-purchase-journal" />Ricezione di una fattura QR con una giornale di registrazione acquisti
...
## <a name="reconciliation" />Riconciliazione
