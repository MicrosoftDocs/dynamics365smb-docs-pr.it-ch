...
ms.author: edupont
---
# <a name="swiss-value-added-tax"></a><a name="swiss-value-added-tax"></a><a name="swiss-value-added-tax"></a>IVA svizzera
...
## <a name="vat-amounts-and-vat-exchange-rates"></a><a name="vat-amounts-and-vat-exchange-rates"></a><a name="vat-amounts-and-vat-exchange-rates"></a>Importi IVA e tassi di cambio IVA
...
### <a name="currency-exchange-rates-for-vat-reporting"></a><a name="currency-exchange-rates-for-vat-reporting"></a><a name="currency-exchange-rates-for-vat-reporting"></a>Tassi di cambio valuta per dichiarazione IVA
