...
ms.author: edupont
---
# <a name="swiss-value-added-tax" />IVA svizzera
...
## <a name="vat-amounts-and-vat-exchange-rates" />Importi IVA e tassi di cambio IVA
...
### <a name="currency-exchange-rates-for-vat-reporting" />Tassi di cambio valuta per dichiarazione IVA
