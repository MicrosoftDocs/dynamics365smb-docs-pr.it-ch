...
ms.author: edupont
---
# <a name="swiss-electronic-payments"></a><a name="swiss-electronic-payments"></a>Pagamenti elettronici svizzeri
...
## <a name="electronic-payment-methods"></a><a name="electronic-payment-methods"></a>Metodi di pagamento elettronico
...
## <a name="sepa-credit-transfers"></a><a name="sepa-credit-transfers"></a>Bonifici SEPA
...
### <a name="iban-and-qr-iban"></a><a name="iban-and-qr-iban"></a><a name="iban-qr"></a>IBAN e QR-IBAN
