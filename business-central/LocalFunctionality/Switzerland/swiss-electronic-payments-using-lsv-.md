...
ms.author: edupont
---
# <a name="swiss-electronic-payments-using-lsv-in-the-swiss-version"></a><a name="swiss-electronic-payments-using-lsv-in-the-swiss-version"></a><a name="swiss-electronic-payments-using-lsv-in-the-swiss-version"></a>Pagamenti elettronici svizzeri tramite LSV+ nella versione per la Svizzera
...
## <a name="automatic-esr-processing"></a><a name="automatic-esr-processing"></a><a name="automatic-esr-processing"></a>Elaborazione ESR automatica
