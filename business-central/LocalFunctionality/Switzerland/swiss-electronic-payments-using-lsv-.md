...
ms.author: edupont
---
# <a name="swiss-electronic-payments-using-lsv-in-the-swiss-version" />Pagamenti elettronici svizzeri tramite LSV+ nella versione per la Svizzera
...
## <a name="automatic-esr-processing" />Elaborazione ESR automatica
