...
ms.author: edupont
---
# <a name="close-an-lsv-collection-in-the-swiss-version"></a><a name="close-an-lsv-collection-in-the-swiss-version"></a><a name="close-an-lsv-collection-in-the-swiss-version"></a>Chiudere una riscossione LSV nella versione per la Svizzera
...
## <a name="to-close-an-lsv-collection"></a><a name="to-close-an-lsv-collection"></a><a name="to-close-an-lsv-collection"></a>Per chiudere una riscossione LSV
...
## <a name="to-reopen-an-lsv-collection"></a><a name="to-reopen-an-lsv-collection"></a><a name="to-reopen-an-lsv-collection"></a>Per riaprire una riscossione LSV
