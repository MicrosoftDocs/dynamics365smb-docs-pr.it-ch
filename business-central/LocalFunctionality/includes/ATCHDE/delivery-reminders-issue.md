...
## <a name="to-issue-delivery-reminders"></a><a name="to-issue-delivery-reminders"></a><a name="to-issue-delivery-reminders"></a>Per emettere solleciti di consegna
...
## <a name="to-view-delivery-reminder-ledger-entries"></a><a name="to-view-delivery-reminder-ledger-entries"></a><a name="to-view-delivery-reminder-ledger-entries"></a>Per visualizzare i movimenti contabili solleciti di consegna
