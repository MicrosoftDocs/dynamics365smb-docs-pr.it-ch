...
## <a name="to-issue-delivery-reminders" />Per emettere solleciti di consegna
...
## <a name="to-view-delivery-reminder-ledger-entries" />Per visualizzare i movimenti contabili solleciti di consegna
