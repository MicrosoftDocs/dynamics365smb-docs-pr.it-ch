...
## <a name="to-create-a-delivery-reminder-manually"></a><a name="to-create-a-delivery-reminder-manually"></a><a name="to-create-a-delivery-reminder-manually"></a>Per creare un sollecito di consegna manualmente
