...
---
# Impostare l'arrotondamento delle fatture
...
## Impostare i conti contabilità generale per le differenze di arrotondamento fattura
...
### Per impostare i conti contabilità generale per le differenze di arrotondamento fattura  
...
## Impostare l'arrotondamento per le valute locali ed estere
...
### Per impostare l'arrotondamento per le valute estere  
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immettere **Valute**, quindi selezionare il collegamento correlato.  
...
### Per impostare l'arrotondamento per la valuta locale
...
## Attivare la funzione di arrotondamento fatture  
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Setup contabilità clienti** o **Setup contabilità fornitori**, quindi seleziona il collegamento correlato.  
