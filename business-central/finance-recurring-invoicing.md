...
---
# <a name="work-with-recurring-revenue-in-"></a>Utilizzo del ricavo ricorrente in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="create-multiple-invoices-based-on-a-recurring-project-journal"></a>Creare più fatture basate su una registrazione progetti ricorrente
...
### <a name="why-use-this-option-1"></a>Perché usare questa opzione
...
### <a name="why-use-this-option-2"></a>Perché usare questa opzione
...
### <a name="why-use-this-option-3"></a>Perché usare questa opzione
...
#### <a name="why-use-this-option-4"></a>Perché usare questa opzione
...
#### <a name="why-use-this-option-5"></a>Perché usare questa opzione
