...
## Incorporazione di caratteri in layout di Word per mantenere la coerenza
...
### Per aggiungere un campo dati o etichetta  
...
### Per aggiungere righe ripetuti di campi dati per creare una lista  
...
##  <a name="RemoveField"></a> Rimuovere i campi etichetta e dati
...
### Per rimuovere un campo dati o etichetta  
...
## Panoramica della parte XML personalizzata
