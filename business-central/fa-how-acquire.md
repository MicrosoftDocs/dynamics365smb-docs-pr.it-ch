...
## Aggiungere un cespite all'elenco dei cespiti
...
### Aggiungere un cespite nella pagina Scheda cespite
...
### Utilizza Modifica in Excel per aggiungere risorse
...
### Aggiungere un cespite da un ordine di acquisto o da una fattura
...
## Acquisire un cespite utilizzando un giornale di registrazione CoGe cespite
...
## Per registrare manualmente un'acquisizione cespiti con un giornale di registrazione CoGe cespiti
...
## Per impostare una lista di componenti per un bene principale
...
## Per annullare una registrazione di costo di acquisto per un cespite
...
## Per registrare il valore di realizzo con il costo di acquisto
