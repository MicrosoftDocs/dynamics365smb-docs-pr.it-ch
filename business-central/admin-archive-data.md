...
|Lavori batch  |
|---------|
|Data Comp. Movimenti budget articoli |
|Compr. data mov. C/C banc. |
|Compr. data mov. cont. clienti |
|Compr. data mov. cespiti |
|Compr. data mov. C/G |
|Compr. data mov. cont. ass. |
|Data Compress Maint. Libro mastro |
|Data Compress Maint. Libro mastro |
|Compr. data mov. cont. risorse |
|Compr. data mov. IVA |
|Compr. data mov. cont. fornitori |
