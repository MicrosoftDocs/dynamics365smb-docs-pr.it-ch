---
title: Crea e gestisci gli elementi del catalogo
...
# <a name="work-with-catalog-items"></a>Lavorare con gli elementi del catalogo
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Articoli di catalogo**, quindi scegli il collegamento correlato.
2. Nella pagina **Elementi catalogo**, seleziona l'azione **Nuovo** .
3. Nella pagina  **Articolo catalogo scheda**, compila i campi come necessario. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Setup articolo di catalogo**, quindi scegli il collegamento correlato.
...
[Crea ordini speciali](sales-how-to-create-special-orders.md)    
