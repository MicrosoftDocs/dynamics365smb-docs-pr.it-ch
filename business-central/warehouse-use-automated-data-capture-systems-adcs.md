---
title: Utilizzare la fondazione Automated Data Capture Systems (ADCS)
...
---
# Utilizzare la fondazione Automated Data Capture Systems (ADCS)
...
## Per abilitare i servizi Web per ADCS

Per utilizzare il sistema di acquisizione automatica dei dati, è necessario abilitare il servizio Web ADCS. È necessario contattare un partner Microsoft in grado implementare un servizio Web che può connettere ADCS e dispositivo portatile specifico. Per ulteriori informazioni sul servizio Web per ADCS, esamina la codeunit 7714: 
 
## Per impostare una warehouse per l'utilizzo di ADCS  
...
## Per specificare un articolo per utilizzare il sistema ADCS  
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Utenti ADCS**, quindi scegli il collegamento correlato.  
...
### Per specificare che un impiegato warehouse è un utente ADCS  
...
## Per creare e personalizzare miniform
...
### Per creare un miniform per ADCS  
...
### Per personalizzare le funzioni del miniform
