...
---
# Utilizzare contratti e offerte di contratto di assistenza
...
## Per creare un contratto o un'offerta di contratto di assistenza  
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Contratti assistenza** o **Offerte contratto assistenza**, quindi seleziona il collegamento correlato.  
...
## Per convertire un'offerta di contratto di assistenza in contratto di assistenza  
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Offerte contratto assistenza**, quindi scegli il collegamento correlato.  
...
## Per creare note di credito di assistenza per un contratto
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Note credito assistenza**, quindi scegli il collegamento correlato.  
...
4. Nel campo **Nr. cliente** immettere il numero del cliente relativo al contratto di assistenza.  
    ...
    > [!NOTE]  
    >  È possibile confrontare la nota di credito con il documento originale registrato nella pagina **Fatture assistenza registrate**. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Fatture assistenza registrate**, quindi scegli il collegamento correlato.  
...
## Aggiornamento e valutazione dei contratti
...
## Per aggiungere una riga di contratto a un contratto di assistenza o a un'offerta di contratto  
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Contratti assistenza**, quindi scegli il collegamento correlato.  
...
## Per eliminare le righe di contratto  
...
## Costo e valore riga assistenza
...
## Per aggiungere uno sconto contrattuale alle offerte di contratto di assistenza  
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Offerte contratto assistenza**, quindi scegli il collegamento correlato.  
...
## Per modificare l'intestatario di un contratto di assistenza  
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Contratti assistenza**, quindi scegli il collegamento correlato. Aprire il contratto di assistenza rilevante di cui si desidera modificare l'intestatario.  
...
## Per aggiornare un prezzo del contratto di assistenza  
È possibile aggiornare i prezzi nei contratti di assistenza indicando una percentuale di aggiornamento del prezzo.  

1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Aggiorna prezzi contratti assistenza**, quindi seleziona il collegamento correlato.
...
## Per registrare movimenti di contratto prepagati  
...
## Modifica dello stato del contratto di assistenza
...
## Per annullare un contratto di assistenza  
...
## Archiviazione di un contratto di assistenza o un'offerta di contratto di assistenza  
