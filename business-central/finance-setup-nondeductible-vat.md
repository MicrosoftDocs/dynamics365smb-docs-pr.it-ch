...
# <a name="set-up-non-deductible-vat" />Impostare l'IVA non detraibile
...
## <a name="use-the-non-deductible-vat-percentage" />Utilizza la percentuale IVA non detraibile
