...
# <a name="set-up-non-deductible-vat"></a><a name="set-up-non-deductible-vat"></a>Impostare l'IVA non detraibile
...
## <a name="use-the-non-deductible-vat-percentage"></a><a name="use-the-non-deductible-vat-percentage"></a>Utilizza la percentuale IVA non detraibile
