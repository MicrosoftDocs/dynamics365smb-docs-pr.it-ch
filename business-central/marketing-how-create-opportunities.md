...
## Per creare un'opportunità da un agente
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Agenti**, quindi scegli il collegamento correlato.
...
## Per creare un'opportunità da un contatto
