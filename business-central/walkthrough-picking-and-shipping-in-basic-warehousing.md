...
Per rendere l'articolo 1928-S disponibile nell'ubicazione SUD seguire i passaggi di seguito riportati:  
  ...
  2. Aprire il giornale di default e quindi creare due righe registrazioni magazzino con le informazioni seguenti sulla data di lavoro (23 gennaio).  
        ...
        |Tipo movimento|Numero di articolo|Codice ubicazione|Codice collocazione|Quantità|  
        |----------------|-----------------|-------------------|--------------|--------------|  
...
1. Scegli l'icona a forma di ![lampadina che consente di aprire la funzionalità delle informazioni 3.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immettere **Ordini vendita**, quindi selezionare il collegamento correlato.  
