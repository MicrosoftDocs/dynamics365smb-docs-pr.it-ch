...
## Impostare la connessione in [!INCLUDE[prod_short](includes/prod_short.md)] nella versione 19 e 20
...
### <a name="onedrivesetupmigration"></a>Informazioni sul passaggio alla nuova integrazione OneDrive
