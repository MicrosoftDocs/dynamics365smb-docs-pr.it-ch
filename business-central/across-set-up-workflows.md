...
---
# <a name="set-up-approval-workflows"></a>Impostazione workflow di approvazione
...
|Impostare un server SMTP per consentire la comunicazione e-mail in entrata e in uscita di [!INCLUDE[prod_short](includes/prod_short.md)]|[Impostare la posta elettronica](admin-how-setup-email.md)|
...
|Condividere workflow con altri database [!INCLUDE[prod_short](includes/prod_short.md)].|[Importare ed esportare workflow di approvazione](across-how-to-export-and-import-workflows.md)|  
