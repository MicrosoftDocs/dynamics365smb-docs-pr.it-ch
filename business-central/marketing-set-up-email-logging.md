...
### Per registrare un'applicazione in Microsoft Entra ID per la connessione da Business Central a Exchange Online
...
2. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Log delle e-mail**, quindi scegli il collegamento correlato. 
