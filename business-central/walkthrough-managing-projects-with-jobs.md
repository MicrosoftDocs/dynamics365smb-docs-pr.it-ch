...
---
# <a name="walkthrough-managing-projects"></a>Procedura dettagliata: Gestione dei progetti con le commesse
...
### <a name="setting-up-a-project"></a>Impostazione di una commessa
...
### <a name="to-create-a-project-journal-batch"></a>Per creare un batch registrazioni commesse
...
## <a name="setting-up-a-project-1"></a>Impostazione di una commessa
...
### <a name="to-set-up-a-project"></a>Per impostare una commessa
...
### <a name="to-add-project-tasks"></a>Per aggiungere task commessa
...
### <a name="to-enter-hours-in-a-project-journal"></a>Per inserire ore nelle Registrazioni commesse
...
## <a name="copying-projects"></a>Copia di commesse
...
### <a name="to-copy-a-project"></a>Per copiare una commessa
