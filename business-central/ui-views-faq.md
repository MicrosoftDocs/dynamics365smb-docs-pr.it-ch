...
### <a name="why-dont-i-have-a-save-icon"></a><a name="save"></a>Perché non è presente un'icona Salva?
...
Uno dei motivi potrebbe essere che la personalizzazione non è abilitata per il ruolo utente. In questo caso, si ha ancora accesso alle visualizzazioni di sistema che sono una parte standard delle pagine. È possibile modificare queste visualizzazioni, come cambiare o aggiungere filtri, ma non salvare le modifiche. Un altro motivo potrebbe essere che la pagina che si sta guardando è un tipo di pagina *prospetto* e non un elenco.
...
### <a name="how-do-i-know-whether-im-on-list-type-page"></a>Come posso sapere se sono in una pagina di tipo elenco?

È necessario utilizzare l'ispezione della pagina. Per aprire l'ispezione della pagina, premere CTRL + ALT + F1. Quindi, nel campo **Pagina**, cercare la parola **Elenco** tra parentesi alla fine.
...
Sì. Tutte le visualizzazioni salvate nel browser desktop o nell'applicazione desktop saranno disponibili anche nel tablet o nello smartphone. Non è possibile modificare o personalizzare visualizzazioni nei dispositivi mobili.
...
### <a name="i-see-multiple-views-on-my-page-but-i-didnt-create-them-where-did-they-come-from"></a>La pagina contiene varie visualizzazioni non create dall'utente. Qual è la loro origine?
