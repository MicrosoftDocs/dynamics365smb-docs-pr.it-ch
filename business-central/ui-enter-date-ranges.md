...
# Utilizzare date e orari del calendario
...
## Verificare le impostazioni di lingua e paese
...
### Selezionare le date dal calendario
...
|-----------|---------------------|--------------------|
|intervallo|15 12 00..01 15 01<br /><br />..15 12 00<br /><br />p1..p4|Record la cui data di risposta è compresa tra il 12 15 00 e il 01 15 01 inclusi.<br /><br />Record con data 12 15 00 o precedente.<br /><br />Intervallo di date che include il secondo, il terzo e il quarto periodo contabile, ad esempio 01/01/20..30/04/20..|
|oppure|15 12 00\|16 12 00|Record con data 12 15 00 o 12 16 00. Se ci sono record con date in entrambi i giorni, saranno tutti visualizzati.|
|Combinazione|15 12 00\|01 12 00..10 12 00  <br /><br />..14 12 00\|30 12 00..|Record con data 12 15 00 o in date tra il 12 01 00 e il 12 10 00 compresi.  <br /><br />Record la cui data è il 12 14 00 o una data precedente oppure il 12 30 00 o una data successiva, ossia tutti i record esclusi quelli la cui data di risposta è compresa tra il 12 15 00 e il 12 29 00 inclusi.|
...
|CA|Mese corrente (ultimo giorno del mese)|
...
## Immissione di date e ore combinate
