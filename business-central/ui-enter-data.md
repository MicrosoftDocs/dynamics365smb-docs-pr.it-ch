...
## Utilizzare i campi modificabili
...
### Modifica di un valore di campo
...
### Funzionamento di Accesso rapido
...
### Come modificare i campi Accesso rapido
...
## Trovare dati durante la digitazione
...
## Copiare e incollare campi e righe
...
### Attivare/disattivare lo stato attivo
...
|w|Specifica la data del lavoro impostata nell'applicazione. Per modificare la data di lavoro, vedere [Modifica delle impostazioni di base](ui-change-basic-settings.md). Potrebbe essere necessario utilizzare una data di lavoro se sono presenti molte transazioni con una data diversa da quella odierna.|
...
## <a name="decimal"></a>Impostazione del separatore decimale usato dalle tastiere numeriche
