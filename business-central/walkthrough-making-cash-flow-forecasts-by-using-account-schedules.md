...
---
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Procedura dettagliata: Esecuzione di previsioni di flusso di cassa utilizzando i report finanziari
...
## <a name="set-up-a-new-financial-report-name"></a>Impostazione di un nuovo nome del report finanziario
...
### <a name="set-up-a-new-financial-report-name-1"></a>Impostare un nuovo nome del report finanziario
...
## <a name="set-up-row-definition-lines"></a>Impostazione delle righe di definizione di riga
...
### <a name="set-up-row-definition-lines-1"></a>Impostare le righe di definizione di riga
...
## <a name="set-up-a-new-column-definition"></a>Impostazione di una nuova definizione di colonna
...
### <a name="set-up-a-new-column-definition-1"></a>Impostare una nuova definizione di colonna
...
4. Immettere ogni riga esattamente come indicato nella tabella riportata di seguito.
    ...
    |Nr. colonna|Testata colonna|Tipo di colonna|Tipo mov. contabile|Tipo di importo|Mostra|  
    |----------|-------------|-----------|-----------------|-----------|----|
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Assegnazione della definizione di colonna al nome del report finanziario
