...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview" />Panoramica dei layout di report e documento
...
## <a name="introduction" />Introduzione
...
## <a name="layout-types" />Tipi di layout
...
## <a name="layout-sources" />Origini del layout
