...
description: Informazioni su come impostare e usare le funzionalità Dichiarazione di servizio e come segnalare le attività commerciali con società in altri paesi UE.
author: altotovi
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
> [!NOTE]
> [!INCLUDE[prod_long](includes/prod_long.md)] viene fornito con la definizione di scambio dati preconfigurata per **Dichiarazione di servizio** per tutti i paesi localizzati. Per informazioni sulla creazione di una nuova definizione di scambio dati, vedi [Impostare le definizioni di scambio dati](across-how-to-set-up-data-exchange-definitions.md).
...
Quando crei una fattura di acquisto o di vendita, nelle relative righe troverai due campi relativi alle dichiarazioni di servizio. Entrambi i campi sono compilati con i valori predefiniti dell'articolo, della risorsa o delle impostazioni di addebito articolo.
