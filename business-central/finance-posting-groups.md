---
title: Configurazione della categoria di registrazione
...
Se il tuo paese utilizza l'imposta sul valore aggiunto (IVA), vedi [Impostare calcoli e metodi di registrazione per l'imposta sul valore aggiunto](finance-setup-vat.md).  
...
## <a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/posting-groups-dynamics-365-business-central/)
