...
# <a name="scheduling-a-synchronization-between-business-central-and-dataverse" />Pianificazione di una sincronizzazione tra Business Central e Dataverse
...
## <a name="default-synchronization-job-queue-entries" />Movimenti coda processi di sincronizzazione predefiniti
...
## <a name="synchronization-process" />Processo sincronizzazione
...
## <a name="about-inactivity-timeouts" />Informazioni sui timeout di inattività
...
## <a name="to-view-the-synchronization-job-log" />Per visualizzare il log processi di sincronizzazione
...
## <a name="to-view-the-synchronization-job-log-from-the-table-mappings" />Per visualizzare il log processi di sincronizzazione dai mapping di tabella
...
## <a name="to-view-the-synchronization-error-log" />Per visualizzare il log processi di sincronizzazione
