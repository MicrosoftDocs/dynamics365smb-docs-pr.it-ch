...
# <a name="audit-file-export"></a><a name="audit-file-export"></a>Esportazione file di controllo
...
## <a name="set-up-audit-file-export"></a><a name="set-up-audit-file-export"></a>Configurazione dell'esportazione dei file di controllo
...
## <a name="provide-the-gl-account-mapping-for-audit-file-export"></a><a name="provide-the-gl-account-mapping-for-audit-file-export"></a>Fornisci il mapping del conto Co.Ge. per l'esportazione del file di controllo
...
## <a name="export-the-audit-file"></a><a name="export-the-audit-file"></a>Esportazione del file di controllo
