---
title: Rettificare il costo di riconciliazione con la contabilità generale utilizzando la coda processi
...
ms.locfileid: "6688481"
---
# <a name="adjust-and-reconcile-inventory-cost-with-general-ledger-with-job-queue"></a>Rettificare e riconciliare il costo di magazzino con la contabilità generale con la coda processi
...
3. Nella notifica che ora viene visualizzata nella parte superiore della pagina, scegliere il collegamento **Pianifica movimento coda processi**.
...
> [!NOTE]
> Per evitare il blocco, non pianificare attività per il batch processi **Rettifica costo - Mov. art.** lavoro batch, il codeunit **Registra costo magazzino in C/G** e le attività per la registrazione di transazioni di vendita o acquisto contemporaneamente e assicurarsi che utilizzino la stessa categoria di coda processi.
