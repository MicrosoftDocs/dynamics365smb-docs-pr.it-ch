...
ms.author: edupont
---
# <a name="set-up-item-tracking-with-serial-lot-and-package-numbers" />Configurare la tracciabilità di articoli con numeri di serie, di lotto e di pacco
...
## <a name="numbers-and-item-tracking" />Numeri e tracciabilità degli articoli
...
## <a name="to-set-up-item-tracking-codes" />Per impostare i codici di tracciabilità articolo
...
## <a name="to-set-up-expiration-rules-for-serial-or-lot-numbers" />Per impostare le regole di scadenza per i numeri seriali e di lotto
...
## <a name="to-set-up-warranties-for-serial-or-lot-numbers" />Per impostare le garanzie per i numeri seriali o di lotto
...
## <a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes" />Per impostare gli articoli per la tracciabilità con i codici di tracciabilità articolo corretti
...
## <a name="to-specify-opening-balances-for-the-items-you-track" />Per specificare i saldi di apertura per gli articoli di cui si tiene traccia
...
### <a name="item-journals" />Registrazioni articoli
...
### <a name="warehouse-physical-inventory-journal-for-locations-where-directed-pick-and-put-away-is-turned-on" />Registrazione dell'inventario fisico warehouse nelle ubicazioni che prevedono l'uso di prelievi e stoccaggi guidati
