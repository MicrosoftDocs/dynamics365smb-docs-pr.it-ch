...
# Impostare l'ammortamento dei cespiti
...
## Per creare un registro beni ammortizzabili
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Registri beni ammortizzabili**, quindi scegli il collegamento correlato.
...
## Per assegnare un registro dei beni ammortizzabili a un cespite
...
## Per assegnare un registro beni ammortizzabili a più cespiti tramite un processo batch
...
## Per impostare i tipi di registrazione dell'ammortamento
...
## Per impostare modelli e batch di default per l'ammortamento dei cespiti
...
## Ammortamento e campo Anno fiscale 365 giorni
