...
## <a name="couple-records"></a>Associazione di record
...
## <a name="fully-synchronize-records"></a>Sincronizzazione completa dei record
...
## <a name="handle-sales-order-data"></a>Gestione di dati di ordini di vendita
...
## <a name="handle-sales-quotes-data"></a>Gestione di dati di offerte di vendita
...
## <a name="handle-posted-sales-invoices-customer-payments-and-statistics"></a>Gestione di spedizioni vendita registrate, pagamenti clienti e statistiche
...
## <a name="handle-sales-prices"></a>Gestione dei prezzi di vendita
> [!NOTE]
