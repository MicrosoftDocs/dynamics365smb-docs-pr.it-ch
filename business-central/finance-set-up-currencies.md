...
ms.locfileid: "9528269"
---
# <a name="set-up-currencies"></a>Impostare le valute

[!INCLUDE [finance-currencies-def](includes/finance-currencies-def.md)]

Puoi utilizzare un servizio esterno per ottenere i tassi di cambio valuta più aggiornati nell'elenco **Valute**. Per ulteriori informazioni, vedere [Per impostare un servizio dei tassi di cambio delle valute](finance-how-update-currencies.md#to-set-up-a-currency-exchange-rate-service).  
...
## <a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)
