...
## <a name="what-microsoft-products-is-the-shopify-connector-available-for"></a>Per quali prodotti Microsoft è disponibile il connettore Shopify?
...
Attualmente, questa app non è estendibile con piani per renderla estensibile in un determinato momento (non ancora specificato) in futuro.
