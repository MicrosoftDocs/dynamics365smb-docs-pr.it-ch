...
Attualmente l'app non è estendibile. Ci aspettiamo di renderlo estendibile in un momento futuro che non è attualmente determinato.

## <a name="contribution"></a>Contributi

Questa estensione è aperta al contributo della community. Puoi trovare il [codice sorgente](https://github.com/microsoft/ALAppExtensions/tree/main/Apps/W1/Shopify) nel repository dei componenti aggiuntivi dell'applicazione Microsoft AL.
