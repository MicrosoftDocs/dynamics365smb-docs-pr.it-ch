...
# <a name="set-up-taxes-for-the-shopify-connection"></a>Impostazione delle imposte per la connessione Shopify
...
In mercati come questi, un prezzo di 100 EUR definito sulla scheda prodotto contiene già l'IVA. Il prezzo, IVA inclusa, viene mostrato al cliente nella vetrina e al momento del pagamento.  

Negli Stati Uniti e in Canada, i clienti non si aspettano di vedere prezzi comprensivi di tasse, perché l'imposta finale dipende dal luogo di spedizione dei prodotti. Le tasse vengono aggiunte al momento del pagamento, pertanto l'opzione  **Tutti i prezzi includono le tasse**  è solitamente disattivata. In questo caso, il prezzo di $100 definito sul prodotto scheda è il prezzo senza tasse. Al momento del pagamento, le tasse vengono aggiunte al prezzo.
...
Shopify utilizza l'aliquota fiscale del paese/regione estero quando calcola i prezzi finali.
