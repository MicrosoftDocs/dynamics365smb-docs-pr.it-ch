...
---
# Domande frequenti sull'accesso con licenze Microsoft 365
...
### Posso configurare in modo proattivo diverse autorizzazioni di avvio per diversi gruppi di utenti?
...
### Posso configurare in modo proattivo autorizzazioni, profili e impostazioni per i singoli utenti prima che accedano?
...
### Dopo che un utente ha effettuato l'accesso, posso modificare gli oggetti a cui ha accesso?
...
### Come posso impedire l'accesso a tabelle sensibili?
...
### Invece di personalizzare la configurazione della licenza, posso personalizzare un gruppo di utenti?
...
### Se configuro autorizzazioni che includono l'accesso in scrittura, gli utenti potranno scrivere in Teams?
...
### Perché l'impostazione per abilitare l'accesso non è disponibile per il mio ambiente?
...
### Posso accedere a Business Central in locale con le licenze Microsoft 365?
...
### Cos'è il profilo del dipendente?
...
### Che cos'è il gruppo di utenti Utenti di Teams?
...
### Gli utenti che dispongono di una sola licenza Microsoft 365 vengono visualizzati nell'elenco Utenti in Business Central?
...
### Questa caratteristica funziona per le soluzioni ISV integrate?
...
### Un cliente può usare questa funzione se non dispone di Business Central?
...
### In che modo questo mi aiuta a gestire i costi di abbonamento nella mia organizzazione?
...
### L'elenco delle licenze in Business Central mostra una licenza Microsoft 365. Guida rapida
...
### Devo acquisire un nuovo tipo di licenza Microsoft 365 affinché funzioni?  
...
### Come faccio a sapere quali utenti hanno una sola licenza Microsoft 365?
...
### Come filtro l'elenco Utenti in Business Central per visualizzare gli utenti che dispongono di una sola licenza Microsoft 365.
...
### E per gli utenti che hanno sia una licenza Microsoft 365 che una licenza Business Central?
...
### Questa licenza è correlata alla licenza Membro del team di Business Central?
...
### Business Central impone un vincolo?
...
### Posso accedere ai record in Teams per iOS e Teams per Android? 
...
### In che modo gli utenti modificano le proprie impostazioni personali in Impostazioni personali? 
...
### Cosa determina la scelta della lingua al primo accesso? 
...
### Perché non riesco ad attivare alcuni dei collegamenti colorati nelle schede e nei dettagli della scheda?
...
### Perché non riesco ad attivare le azioni di notifica della pagina?
...
### Gli utenti Microsoft 365 possono rimuovere le schede?
...
### Se non riesco a filtrare, vedrò comunque un elenco filtrato creato da altri?
