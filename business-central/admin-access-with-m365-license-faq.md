...
## <a name="permissions"></a>[Autorizzazioni](#tab/permissions) 
...
## <a name="setup-and-configuration"></a>[Configurazione e impostazione](#tab/setup)
...
## <a name="licensing"></a>[Licenze](#tab/license)
...
## <a name="usage"></a>[Utilizzo](#tab/usage)
