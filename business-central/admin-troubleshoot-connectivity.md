...
2. Nell'indirizzo, inserisci l'URL che utilizzi per aprire Business Central e aggiungi `/connectivity` alla fine. 
    ...
    Oppure, se l'URL include l'ID tenant, ad esempio  `https://businesscentral.dynamics.com/aaaabbbb-0000-cccc-1111-dddd2222eeee`, allora dovresti inserire:
...
## <a name="business-central-environments-discovery"></a>Individuazione degli ambienti Business Central
