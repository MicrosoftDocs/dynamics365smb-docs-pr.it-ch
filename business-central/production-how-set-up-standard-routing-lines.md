...
---
# Impostare righe di ciclo standard
...
## Per impostare un task standard

1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Task standard**, quindi scegli il collegamento correlato.
...
## Per aggiungere un task standard a un'operazione

1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Cicli**, quindi scegli il collegamento correlato.
