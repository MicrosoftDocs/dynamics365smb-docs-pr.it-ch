...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents" />Conteggio e regolazione del magazzino utilizzando documenti
...
## <a name="to-create-a-physical-inventory-order" />Per creare un ordine di inventario fisico
...
## <a name="to-create-a-physical-inventory-recording" />Per creare una registrazione di inventario fisico
...
## <a name="to-finish-a-physical-inventory-recording" />Terminare una registrazione di inventario fisico
...
## <a name="to-complete-a-physical-inventory-order" />Per completare un ordine di inventario fisico
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />Per trovare righe di ordine di inventario fisico duplicate
...
### <a name="to-post-a-physical-inventory-order" />Per registrare un ordine di inventario fisico
...
### <a name="to-view-posted-physical-inventory-orders" />Per visualizzare ordini di inventario fisico registrati
...
## <a name="handling-item-tracking-when-counting-inventory" />Gestione della tracciabilità degli articoli durante il conteggio dell'inventario
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Esempio - Preparare una registrazione di inventario fisico per un articolo tracciato
...
### <a name="example---record-and-post-counted-lot-number-differences" />Esempio - Registrare e inserire le differenze nei numeri di lotto conteggiati
...
## <a name="inventory-documents" />Documenti di magazzino
...
### <a name="to-set-up-numbering-for-inventory-documents" />Per impostare la numerazione per i documenti di magazzino
...
### <a name="to-create-and-post-an-inventory-document" />Per creare e registrare un documento di magazzino
...
## <a name="printing-inventory-documents" />Stampa dei documenti di magazzino
