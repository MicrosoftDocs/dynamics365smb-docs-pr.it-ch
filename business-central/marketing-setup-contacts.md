...
| Impostare le origini Web (motori di ricerca e siti Web) che è possibile utilizzare quando si cercano informazioni sui contatti in Internet. |[Impostare l'origine Web nei contatti](marketing-web-sources.md) |
