...
## <a name="to-assign-industry-groups-to-a-contact"></a> Per assegnare settori industriali a un contatto
...
## <a name="to-define-a-contacts-alternate-address"></a>Per definire l'indirizzo alternativo di un contatto
...
## <a name="to-assign-job-responsibilities-to-a-contact"></a>Per assegnare ruoli professionali a un contatto
...
## <a name="to-assign-organizational-levels-to-a-contact"></a>Per assegnare livelli organizzativi a un contatto
...
## <a name="to-assign-web-sources-to-a-contact"></a>Per assegnare origini Web a un contatto
...
## <a name="to-assign-business-relations-to-a-contact"></a> Per assegnare relazioni d'affari a un contatto
