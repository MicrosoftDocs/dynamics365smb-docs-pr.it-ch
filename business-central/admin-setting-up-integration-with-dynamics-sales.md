...
ms.author: bholtorf
---
# <a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse"></a><a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse"></a><a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse"></a>Impostazione di account utente per l'integrazione con Microsoft Dataverse
...
## <a name="set-up-the-administrator-user-account"></a><a name="set-up-the-administrator-user-account"></a><a name="set-up-the-administrator-user-account"></a>Impostare l'account utente amministratore
...
## <a name="permissions-and-security-roles-for-user-accounts-in-"></a><a name="permissions-and-security-roles-for-user-accounts-in-"></a><a name="permissions-and-security-roles-for-user-accounts-in-"></a>Autorizzazioni e ruoli di sicurezza per gli account utente in [!INCLUDE[prod_short](includes/cds_long_md.md)]
