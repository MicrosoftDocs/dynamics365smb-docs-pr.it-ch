...
ms.author: jswymer
---
# <a name="personalize-your-workspace"></a>Personalizza l'area di lavoro
...
> [!NOTE]
> A causa delle limitazioni sulle capacità di progettazione nel client Web, al momento non è possibile personalizzare i controlli all'interno della sintassi `grid` e `fixed`.
...
## <a name="change-the-width-of-a-column"></a>Modificare la larghezza di una colonna
...
## <a name="start-personalizing-by-using-the-personalization-mode"></a>Iniziare a personalizzare utilizzando la modalità di personalizzazione
...
|Ignorare un campo quando si preme INVIO.|Seleziona la freccia accanto al campo, o l'intestazione di una colonna in un elenco, e scegli **Escludi da Immissione rapida**.  | Se **Escludi da Immisione rapida** non è visibile, il campo è già ignorato. In tal caso, per smettere di ignorare il campo, scegliere **Includi in Accesso rapido**.<br><br>[Ulteriori informazioni su Immissione rapida](ui-enter-data.md#QuickEntry)|
...
## <a name="personalize-action-bar-and-menus"></a><a name="Actions"></a>Personalizzare la barra delle azioni e i menu
...
### <a name="remove-hide-and-show-actions-and-action-groups"></a>Rimuovere, nascondere e visualizzare azioni e gruppi di azioni
...
### <a name="move-actions-and-action-groups"></a>Spostare azioni e gruppi di azioni
...
### <a name="about-the-automate-menu"></a>Informazioni sul menu Automatizza
...
## <a name="personalize-parts"></a><a name="Parts"></a>Personalizzare le parti
...
## <a name="work-with-fields-and-columns"></a><a name="fields"></a>Utilizzare campi e colonne

Quando personalizzi una pagina, utilizza il riquadro **Aggiungi campo a pagina** per includere campi o colonne sulla pagina che attualmente sono nascosti dalla visualizzazione. Per aprire questo riquadro, seleziona l'azione **+ Campo** nella parte superiore della pagina. A differenza di altri elementi nascosti, i campi nascosti non sono indicati nella pagina stessa in modalità di personalizzazione. Tuttavia, puoi identificare i campi nascosti utilizzando il riquadro **Aggiungi campo a pagina**.

Ecco alcune linee guida generali da seguire quando si utilizza il riquadro **Aggiungi campo a pagina**:

- Per impostazione predefinita, il riquadro elenca tutti i campi nascosti. I campi nascosti, contrassegnati dall'icona ![icona Mostra campo nascosto](media/hidden-icon.png "Icona Mostra campo nascosto").
- Puoi filtrare l'elenco per mostrare altri campi, ad esempio, come quelli attualmente visualizzati nella pagina, selezionando il pulsante **Campi consigliati** sopra l'elenco e scegliendo un'opzione di filtro. Il nome del pulsante cambia in base all'opzione di filtro scelta.
...
### <a name="add-a-field-so-its-visible-on-the-page"></a>Aggiungere un campo in modo che sia visibile sulla pagina

Dal riquadro **Aggiungi campo alla pagina**, sono disponibili due modi per includere un campo attualmente nascosto nella pagina:
...
> [!NOTE]
> Alcuni campi che aggiungi non saranno modificabili nella pagina una volta terminata la personalizzazione. Questi campi sono stati originariamente progettati in questo modo oppure un amministratore [ha personalizzato](ui-personalization-manage.md) la pagina per impedirti di modificarli.

## <a name="clear-personalization"></a>Cancella individualizzazione
...
## <a name="tips-and-other-points-of-interest"></a>Suggerimenti e altri punti di interesse
