...
2. In alternativa, fare doppio clic sul bordo tra due colonne per adattare automaticamente la larghezza della colonna. In questo modo si imposta la larghezza ottimale per la migliore leggibilità.
...
## <a name="see-related-training-at-microsoft-learn"></a>Vedi le informazioni relative al training in [Microsoft Learn](/learn/modules/personalize-ui-dynamics-365-business-central/index)
