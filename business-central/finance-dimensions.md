...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Dimensioni**, quindi scegli il collegamento correlato.  
...
### Per impostare priorità nelle dimensioni di default
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Priorità dimensioni di default**, quindi seleziona il collegamento correlato.  
...
### Per impostare combinazioni dimensioni
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Combinazioni di dimensioni**, quindi seleziona il collegamento correlato.  
...
### Per impostare dimensioni globali e a collegamento rapido
...
## Sintesi delle dimensioni utilizzate più volte
