...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Procedura dettagliata: Pianificazione automatica degli approvvigionamenti
...
## <a name="preparing-sample-data" />Preparazione dei dati di esempio
...
### <a name="to-create-stockkeeping-units" />Per creare unità di stockkeeping
...
### <a name="to-change-selected-planning-parameters" />Per variare i parametri di pianificazione selezionati
...
## <a name="creating-a-regenerative-supply-plan" />Creazione di un piano di approvvigionamento rigenerativo
...
### <a name="to-create-the-sales-order" />Per creare l'ordine di vendita
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />Per creare un piano rigenerativo per soddisfare la domanda presso l'ubicazione EST
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />Per calcolare MRP per includere i componenti necessari sottostanti
...
## <a name="analyzing-the-planning-result" />Analisi del risultato della pianificazione
...
### <a name="to-check-the-planning-parameter" />Per controllare il parametro di pianificazione
...
### <a name="to-view-more-order-tracking-entries" />Per visualizzare ulteriori movimenti di tracciabilità ordine
...
## <a name="carrying-out-action-messages" />Esecuzione di messaggi di azione
...
### <a name="to-automatically-create-the-suggested-supply-orders" />Per creare automaticamente gli ordini di approvvigionamento suggeriti
...
## <a name="creating-a-net-change-plan" />Creazione di un piano solo cambiamenti
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />Per creare le nuove domande di vendita e ripianificare di conseguenza
...
## <a name="analyzing-the-changed-planning-result" />Analisi del risultato della pianificazione modificata
...
### <a name="to-view-an-existing-order" />Per visualizzare un ordine esistente
