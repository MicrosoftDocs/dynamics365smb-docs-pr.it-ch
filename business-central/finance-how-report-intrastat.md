...
description: Scopri come dichiarare gli scambi con aziende in altri paesi dell'UE utilizzando il sistema Intrastat.
author: altotovi
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
4. Nel campo **Periodo statistico** specifica il mese per il quale riportare i dati. Immetti il periodo come numero di quattro cifre senza spazi o simboli. A seconda del tuo paese, inserisci prima il mese e poi l'anno o viceversa. Immetti, ad esempio, *2206* o *0622* per indicare giugno 2022.
