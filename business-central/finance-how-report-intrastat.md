...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") Icona, immettere **Elenco report Intrastat** e scegliere il relativo collegare.
...
3. Selezionare **OK** per avviare il processo batch.
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Lista Intrastat**, quindi scegli il collegamento correlato.
