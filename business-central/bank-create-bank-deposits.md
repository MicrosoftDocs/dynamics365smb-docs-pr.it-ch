...
## <a name="finding-posted-bank-deposits"></a>Ricerca dei depositi bancari registrati
...
## <a name="reversing-a-posted-bank-deposit"></a>Storno di un deposito bancario registrato
