...
description: 'Scopri come ricevere articoli nel tuo warehouse, registrarli e abbinarli ai documenti di origine in entrata.'
author: brentholtorf
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
In linea di principio, il processo di ricezione degli ordini in entrata consiste in due attività:

* Ricevi gli articoli nella zona di ricezione, identifica gli articoli, associali a un documento di origine e registra la quantità ricevuta.
...
|**Task**|**Vedere**|  
|------------|-------------|  
|Ricevi gli articoli nelle ubicazioni della warehouse con un carico warehouse per un'elaborazione parzialmente o completamente automatizzata della warehouse.|[Ricevere articoli](warehouse-how-receive-items.md)|
