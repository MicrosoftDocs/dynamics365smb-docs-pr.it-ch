...
ms.author: bholtorf
---
# <a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a>Dettagli di progettazione: Flusso warehouse in entrata
...
## <a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a>Nessuna attività di warehouse dedicata
...
## <a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a>Configurazioni warehouse di base
...
### <a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a>1: Rilasciare un documento di origine per creare una richiesta per uno stoccaggio in magazzino
...
### <a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a>2: Creare uno stoccaggio magazzino
...
### <a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a>3: Registrare uno stoccaggio di magazzino
...
## <a name="advanced-warehouse-configurations"></a><a name="advanced-warehouse-configurations"></a>Configurazioni avanzate della warehouse
...
### <a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a>1: Rilasciare il documento di origine
...
### <a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a>2: Creare un carico warehouse
...
### <a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a>3: Registrare il carico warehouse
...
### <a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a>4: (Facoltativo) Generare le righe del prospetto di stoccaggio
...
### <a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a>5: Creare un documento di stoccaggio warehouse
...
### <a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a>6: Registrare uno stoccaggio warehouse
...
## <a name="related-tasks"></a><a name="related-tasks"></a>Attività correlate
