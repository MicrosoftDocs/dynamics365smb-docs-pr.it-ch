...
|Esportare i dati per il reporting Intrastat in [!INCLUDE[prod_short](includes/prod_short.md)].|[Impostare il report Intrastat](finance-how-setup-report-intrastat.md)|
