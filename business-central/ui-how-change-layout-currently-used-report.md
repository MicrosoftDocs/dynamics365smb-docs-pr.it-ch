...
---
# (Legacy) Impostare il layout utilizzato da un report
...
## Per modificare il layout di report da utilizzare per un report o un documento
...
## Per modificare il layout personalizzato da utilizzare per un layout di report
