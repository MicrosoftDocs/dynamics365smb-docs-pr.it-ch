...
# <a name="the-quickbooks-online-data-migration-extension"></a><a name="the-quickbooks-online-data-migration-extension"></a><a name="the-quickbooks-online-data-migration-extension"></a>Estensione di migrazione dei dati QuickBooks Online
...
## <a name="what-data-can-i-import-from-quickbooks-online"></a><a name="what-data-can-i-import-from-quickbooks-online"></a><a name="what-data-can-i-import-from-quickbooks-online"></a>Quali dati si possono importare da QuickBooks Online?
...
## <a name="before-you-start"></a><a name="before-you-start"></a><a name="before-you-start"></a>Operazioni preliminari
...
## <a name="how-do-i-start-using-the-extension"></a><a name="how-do-i-start-using-the-extension"></a><a name="how-do-i-start-using-the-extension"></a>Operazioni iniziali per l'utilizzo dell'estensione
...
## <a name="what-do-i-do-after-i-migrate-data"></a><a name="what-do-i-do-after-i-migrate-data"></a><a name="what-do-i-do-after-i-migrate-data"></a>Operazioni successive alla migrazione dei dati
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/migrate-data-dynamics-365-business-central/)
