...
# <a name="the-quickbooks-online-data-migration-extension" />Estensione di migrazione dei dati QuickBooks Online
...
## <a name="what-data-can-i-import-from-quickbooks-online" />Quali dati si possono importare da QuickBooks Online?
...
## <a name="how-do-i-start-using-the-extension" />Operazioni iniziali per l'utilizzo dell'estensione
...
## <a name="what-do-i-do-after-i-migrate-data" />Operazioni successive alla migrazione dei dati
...
## <a name="see-related-microsoft-trainingtrainingmodulesmigrate-data-dynamics--business-central" />Vedi il relativo [training Microsoft](/training/modules/migrate-data-dynamics-365-business-central/)
