...
# <a name="install-and-uninstall-extensions-apps-in-business-central"></a><a name="install-and-uninstall-extensions-apps-in-business-central"></a>Installare e disinstallare le estensioni (app) in Business Central
...
## <a name="install-an-extension"></a><a name="install-an-extension"></a><a name="install"></a>Installare un'estensione
...
## <a name="set-up-an-app"></a><a name="set-up-an-app"></a>Impostare un'app
...
## <a name="upload-a-per-tenant-extension-pte"></a><a name="upload-a-per-tenant-extension-pte"></a>Caricare un'estensione per tenant (PTE)
...
## <a name="uninstall-an-app"></a><a name="uninstall-an-app"></a>Disinstallare un'app
