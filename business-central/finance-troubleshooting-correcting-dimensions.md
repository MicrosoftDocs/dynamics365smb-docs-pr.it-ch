...
## <a name="troubleshooting-dimensions-errors"></a>Risoluzione degli errori relativi alle dimensioni
...
### <a name="dimension-corrections-on-large-data-sets"></a>Correzioni delle dimensioni in set di dati di grandi dimensioni
...
### <a name="use-analysis-views-with-dimension-corrections"></a>Utilizzare le visualizzazioni analisi con correzioni delle dimensioni
