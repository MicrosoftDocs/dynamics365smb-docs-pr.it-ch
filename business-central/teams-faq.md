...
---
# <a name="teams-faq"></a><a name="teams-faq"></a>Domande frequenti su Teams
...
### <a name="how-do-i-sign-in-to-the--app-in-teams"></a><a name="how-do-i-sign-in-to-the--app-in-teams"></a>Come si accede all'app [!INCLUDE [prod_short.md](includes/prod_short.md)] in Teams?
...
### <a name="how-do-i-sign-out-of-the--app-in-teams"></a><a name="how-do-i-sign-out-of-the--app-in-teams"></a>Come ci si disconnette dall'app [!INCLUDE [prod_short.md](includes/prod_short.md)] in Teams?
...
### <a name="does-the-app-for-teams-connect-to--on-premises"></a><a name="does-the-app-for-teams-connect-to--on-premises"></a>L'app per Teams si connette a [!INCLUDE [prod_short.md](includes/prod_short.md)] in locale?
...
### <a name="does-the-app-work-with-multiple-companies-and-environments"></a><a name="does-the-app-work-with-multiple-companies-and-environments"></a>L'app è utilizzabile con più società e ambienti?
...
### <a name="in-which-countries-or-regions-is-the--app-available"></a><a name="in-which-countries-or-regions-is-the--app-available"></a>In quali paesi o regioni è disponibile l'app [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a><a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a>L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] è utilizzabile con qualsiasi localizzazione di [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="which-languages-does-the--app-support"></a><a name="which-languages-does-the--app-support"></a><a name="language"></a>Quali lingue sono supportate dall'app [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-the--app-work-with-industry-solutions"></a><a name="does-the--app-work-with-industry-solutions"></a>L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] funziona con le soluzioni del settore?
...
### <a name="does--work-with-the-teams-mobile-app"></a><a name="does--work-with-the-teams-mobile-app"></a>[!INCLUDE [prod_short.md](includes/prod_short.md)] è utilizzabile con l'app per dispositivi mobili Teams?
...
### <a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a><a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a>L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams è uguale all'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per iOS e Android?
...
### <a name="does-the--app-work-in-all-teams-clients"></a><a name="does-the--app-work-in-all-teams-clients"></a>L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] è utilizzabile in tutti i client Teams?
...
### <a name="which-teams-client-is-best-for-"></a><a name="which-teams-client-is-best-for-"></a>Qual è il migliore client Teams per [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a><a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a>Qual è il modo migliore di presentare [!INCLUDE [prod_short.md](includes/prod_short.md)] e Microsoft Teams a potenziali clienti?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a><a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a>L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams consente la personalizzazione?
...
### <a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a><a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a>In che modo le autorizzazioni richieste dall'app influiscono sulla privacy?
...
### <a name="where-can-i-learn-about-my-privacy"></a><a name="where-can-i-learn-about-my-privacy"></a>Dove posso ottenere informazioni sulla privacy?
...
### <a name="how-do-i-uninstall-the--app-for-teams"></a><a name="how-do-i-uninstall-the--app-for-teams"></a>Come si disinstalla l'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams?
...
### <a name="will-microsoft-continue-to-improve-the--app-for-teams"></a><a name="will-microsoft-continue-to-improve-the--app-for-teams"></a>Microsoft continuerà a migliorare l'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a><a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a>Dove posso trovare l'integrazione di Teams nel client Web di Business Central?
...
### <a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-view"></a>Chi può vedere il contenuto di una scheda?
...
### <a name="where-does-the-recommended-content-come-from"></a><a name="where-does-the-recommended-content-come-from"></a><a name=#recommended-content></a>Da dove provengono i contenuti consigliati?
...
### <a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a><a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a>Quando creo una scheda, concede autorizzazioni alle persone nel canale o nella chat?
...
### <a name="can-i-chat-alongside-a-tab"></a><a name="can-i-chat-alongside-a-tab"></a>Posso chattare accanto a una scheda?

Sì. Usa l'icona della chat per iniziare la conversazione. Questo thread di chat viene quindi associato alla scheda. 

### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a><a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a>Se rimuovo una scheda da una chat o da un canale, i dati di Business Central vengono eliminati?

Nr.

### <a name="can-i-safely-rename-a-tab"></a><a name="can-i-safely-rename-a-tab"></a>Posso rinominare una scheda in sicurezza?

Sì. Il contenuto della scheda non è correlato al nome effettivo della scheda. Rinomina a piacimento! 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a><a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a>Ho bisogno di operare su attività in diverse finestre. Posso farlo?

Sì. Puoi far uscire la scheda nella relativa finestra del browser per mostrare il client Web di Business Central. 

### <a name="can-i-add-or-pin-tab-in-team-meetings"></a><a name="can-i-add-or-pin-tab-in-team-meetings"></a>Posso aggiungere una scheda nelle riunioni di Teams?

Nr. L'app Business Central per Teams non supporta le schede nelle riunioni.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a><a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a>Non è possibile aggiungere una scheda se si utilizzano URL ISV come *.bc.dynamics.com (ma è possibile aggiungerle)
...
### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a><a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a>Il contenuto della scheda si aggiorna automaticamente? In caso negativo, come posso aggiornarlo?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a><a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a>Questo consente di visualizzaare elenchi e record dalle mie personalizzazioni e dei miei componenti aggiuntivi?

Sì. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a><a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a>Quando aggiungo una scheda, le persone la vedranno nella mia lingua?
...
### <a name="can-i-have-multiple-tabs-pointing-to-different-content"></a><a name="can-i-have-multiple-tabs-pointing-to-different-content"></a>Posso avere più schede che puntano a contenuti diversi?

Sì.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a><a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a>Posso anche aggiungere schede per chattare con una sola persona?
...
### <a name="can-i-switch-companies-within-a-tab"></a><a name="can-i-switch-companies-within-a-tab"></a>Posso cambiare azienda all'interno di una scheda?

Nr. 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a><a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a>È diverso dall'utilizzo della capacità generica di Teams di creare una scheda che ospita un sito Web?
...
### <a name="which-tables-does-the-app-search-in"></a><a name="which-tables-does-the-app-search-in"></a>In quali tabelle l'app esegue la ricerca?
...
### <a name="which-fields-in-the-contacts-table-can-i-search"></a><a name="which-fields-in-the-contacts-table-can-i-search"></a>In quali campi della tabella dei contatti posso eseguire la ricerca?
...
### <a name="do-search-results-include-companies-and-persons"></a><a name="do-search-results-include-companies-and-persons"></a>I risultati della ricerca includono aziende e persone?
...
### <a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a><a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a>I contatti di una relazione d'affari compaiono nei risultati?
...
### <a name="can-i-look-up-contact-details-during-meetings"></a><a name="can-i-look-up-contact-details-during-meetings"></a>Posso cercare i dettagli di contatto durante le riunioni?
...
### <a name="how-do-i-view-my-last-interactions-with-a-contact"></a><a name="how-do-i-view-my-last-interactions-with-a-contact"></a>Come posso visualizzare le mie ultime interazioni con un contatto?
...
### <a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a><a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a>Come si registra una chiamata o una riunione di Teams come interazione?
...
### <a name="can-i-call-a-contact-from-the--app-for-teams"></a><a name="can-i-call-a-contact-from-the--app-for-teams"></a>Posso chiamare un contatto dall'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams?
...
### <a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a><a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a>Come si visualizzano i documenti recenti per un cliente o un fornitore?
...
### <a name="how-do-i-search-for-contacts-using-special-characters"></a><a name="how-do-i-search-for-contacts-using-special-characters"></a>Come cerco i contatti che usano caratteri speciali?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company"></a><a name="how-can-i-search-contacts-stored-in-a-different-company"></a>Come posso cercare i contatti archiviati in un'altra azienda?
...
### <a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a><a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a>I contatti [!INCLUDE [prod_short.md](includes/prod_short.md)] sono diversi da quelli nella schermata dei contatti di Teams?
...
### <a name="does--synchronize-contacts-with-teams"></a><a name="does--synchronize-contacts-with-teams"></a>[!INCLUDE [prod_short.md](includes/prod_short.md)] sincronizza i contatti con Teams?
...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a><a name="what-is-the-minimum-version-of--for-contact-search"></a>Qual è la versione minima di [!INCLUDE [prod_short.md](includes/prod_short.md)] per la ricerca di contatti?
...
### <a name="can-i-search-from-my-mobile-device"></a><a name="can-i-search-from-my-mobile-device"></a>Posso eseguire ricerche dal mio dispositivo mobile?

In questo momento la ricerca dei contatti non è disponibile da Teams per iOS e Teams per Android.

### <a name="which-permissions-do-i-need-for-contact-search"></a><a name="which-permissions-do-i-need-for-contact-search"></a>Di quali autorizzazioni ho bisogno per la ricerca dei contatti?
...
### <a name="can-i-use-contact-search-if-im-a-delegated-admin"></a><a name="can-i-use-contact-search-if-im-a-delegated-admin"></a>Posso utilizzare la ricerca dei contatti se sono un amministratore delegato?
...
### <a name="is-contact-search-affected-by-api-limits"></a><a name="is-contact-search-affected-by-api-limits"></a>La ricerca dei contatti è interessata dai limiti dell'API?
...
### <a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a><a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a>Perché a volte mi chiede di configurare l'app?
...
### <a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a><a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a>Vorrei eseguire la ricerca di elementi o record da altre tabelle. Posso farlo da Teams?
...
### <a name="which-types-of-links-does-the-app-support"></a><a name="which-types-of-links-does-the-app-support"></a>Quali tipi di collegamento supporta l'app?
...
### <a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a><a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a>Come elimino una scheda che ho inviato a una chat?
...
### <a name="do-cards-always-show-up-to-date-information"></a><a name="do-cards-always-show-up-to-date-information"></a>Le schede mostrano sempre informazioni aggiornate?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a><a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a>Perché le schede non mostrano più informazioni anziché solo il nome della pagina e il pulsante dei dettagli?
...
### <a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a><a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a>Gli altri utenti vedranno la mia scheda se non hanno l'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a><a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a>Come faccio a sapere a quale società appartiene una scheda in Teams?
...
### <a name="where-is-the-save-button-in-the-details-window-in-teams"></a><a name="where-is-the-save-button-in-the-details-window-in-teams"></a>Dov'è il pulsante Salva nella finestra dei dettagli in Teams?
...
### <a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a><a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a>Se scelgo di visualizzare i dettagli di una scheda, gli altri utenti vedranno la finestra dei dettagli?
...
### <a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a><a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a>Posso avviare una chiamata Teams dalla finestra dei dettagli in Teams?
...
### <a name="can-i-print-documents-from-the-details-window-in-teams"></a><a name="can-i-print-documents-from-the-details-window-in-teams"></a>Posso stampare documenti dalla finestra dei dettagli in Teams?
...
### <a name="can-i-access-the-camera-from-the-details-window-in-teams"></a><a name="can-i-access-the-camera-from-the-details-window-in-teams"></a>Posso accedere alla fotocamera dalla finestra dei dettagli in Teams?
...
### <a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="location"></a>Posso accedere alla mia posizione dalla finestra dei dettagli in Teams?
...
### <a name="how-do-i-open-the-details-in-a-new-window"></a><a name="how-do-i-open-the-details-in-a-new-window"></a>Come apro i dettagli in una nuova finestra?
...
### <a name="can-i-share-cards-with-users-outside-my-organization"></a><a name="can-i-share-cards-with-users-outside-my-organization"></a>Posso condividere le schede con utenti esterni all'organizzazione?
...
### <a name="is-the-experience-any-different-for-users-that-are-guests"></a><a name="is-the-experience-any-different-for-users-that-are-guests"></a>L'esperienza è differenti per gli utenti ospiti?
...
### <a name="how-does-a-guest-user-install-the--app"></a><a name="how-does-a-guest-user-install-the--app"></a>In che modo un utente guest installa l'app [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-share-to-teams-send-a-compact-card"></a><a name="does-share-to-teams-send-a-compact-card"></a>Condividi in Teams invia una scheda compatta?

Sì. Il collegamento si espande automaticamente in una scheda se hai installato l'app Business Central per Teams. 

### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a><a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a>I destinatari riceveranno il messaggio da me o da un account del servizio Business Central?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises"></a><a name="is-share-to-teams-available-in-business-central-on-premises"></a>Condividi in Teams è disponibile in Business Central on premises?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients"></a><a name="does-share-to-teams-grant-permissions-to-recipients"></a>Condividi in Teams concede i permessi ai destinatari?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a><a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a>Devo avere l'applicazione desktop Teams installata per usare Condividi in Teams?

No. Tutto ciò di cui avete bisogno è un account valido che abbia accesso a Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients"></a><a name="is-share-to-teams-available-in-all-business-central-clients"></a>Condividi in Teams è disponibile in tutti i clienti di Business Central?
...
### <a name="where-do-i-find-share-to-teams-in-business-central"></a><a name="where-do-i-find-share-to-teams-in-business-central"></a>Dove trovo Condividi in Teams in Business Central?
