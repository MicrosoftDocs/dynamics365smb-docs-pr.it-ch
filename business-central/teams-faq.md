...
---
# <a name="teams-faq" />Domande frequenti su Teams
...
### <a name="how-do-i-sign-in-to-the-include-prodshortmdincludesprodshortmd-app-in-teams" />Come si accede all'app [!INCLUDE [prod_short.md](includes/prod_short.md)] in Teams?
...
### <a name="how-do-i-sign-out-of-the-include-prodshortmdincludesprodshortmd-app-in-teams" />Come ci si disconnette dall'app [!INCLUDE [prod_short.md](includes/prod_short.md)] in Teams?
...
### <a name="does-the-app-for-teams-connect-to-include-prodshortmdincludesprodshortmd-on-premises" />L'app per Teams si connette a [!INCLUDE [prod_short.md](includes/prod_short.md)] in locale?
...
### <a name="does-the-app-work-with-multiple-companies-and-environments" />L'app è utilizzabile con più società e ambienti?
...
### <a name="in-which-countries-or-regions-is-the-include-prodshortmdincludesprodshortmd-app-available" />In quali paesi o regioni è disponibile l'app [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-with-any-localization-of-include-prodshortmdincludesprodshortmd" />L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] è utilizzabile con qualsiasi localizzazione di [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="a-namelanguageawhich-languages-does-the-include-prodshortmdincludesprodshortmd-app-support" /><a name="language"></a>Quali lingue sono supportate dall'app [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-with-industry-solutions" />L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] funziona con le soluzioni del settore?
...
### <a name="does-include-prodshortmdincludesprodshortmd-work-with-the-teams-mobile-app" />[!INCLUDE [prod_short.md](includes/prod_short.md)] è utilizzabile con l'app per dispositivi mobili Teams?
...
### <a name="is-the-include-prodshortmdincludesprodshortmd-app-for-teams-the-same-as-the-include-prodshortmdincludesprodshortmd-app-for-ios-and-android" />L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams è uguale all'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per iOS e Android?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-in-all-teams-clients" />L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] è utilizzabile in tutti i client Teams?
...
### <a name="which-teams-client-is-best-for-include-prodshortmdincludesprodshortmd" />Qual è il migliore client Teams per [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate-include-prodshortmdincludesprodshortmd-and-microsoft-teams-to-prospective-customers" />Qual è il modo migliore di presentare [!INCLUDE [prod_short.md](includes/prod_short.md)] e Microsoft Teams a potenziali clienti?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-for-teams-cater-to-my-customization-and-personalization" />L'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams consente la personalizzazione?
...
### <a name="how-do-the-permissions-required-by-the-app-affect-my-privacy" />In che modo le autorizzazioni richieste dall'app influiscono sulla privacy?
...
### <a name="where-can-i-learn-about-my-privacy" />Dove posso ottenere informazioni sulla privacy?
...
### <a name="how-do-i-uninstall-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Come si disinstalla l'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams?
...
### <a name="will-microsoft-continue-to-improve-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Microsoft continuerà a migliorare l'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client" />Dove posso trovare l'integrazione di Teams nel client Web di Business Central?
...
### <a name="a-namewho-can-viewawho-can-see-the-content-of-a-tab" /><a name="who-can-view"></a>Chi può vedere il contenuto di una scheda?
...
### <a name="a-namerecommended-contentawhere-does-the-recommended-content-come-from" /><a name=#recommended-content></a>Da dove provengono i contenuti consigliati?
...
### <a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat" />Quando creo una scheda, concede autorizzazioni alle persone nel canale o nella chat?
...
### <a name="can-i-chat-alongside-a-tab" />Posso chattare accanto a una scheda?

Sì. Usa l'icona della chat per iniziare la conversazione. Questo thread di chat viene quindi associato alla scheda. 

### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted" />Se rimuovo una scheda da una chat o da un canale, i dati di Business Central vengono eliminati?

Nr.

### <a name="can-i-safely-rename-a-tab" />Posso rinominare una scheda in sicurezza?

Sì. Il contenuto della scheda non è correlato al nome effettivo della scheda. Rinomina a piacimento! 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this" />Ho bisogno di operare su attività in diverse finestre. Posso farlo?

Sì. Puoi far uscire la scheda nella relativa finestra del browser per mostrare il client Web di Business Central. 

### <a name="can-i-add-or-pin-tab-in-team-meetings" />Posso aggiungere una scheda nelle riunioni di Teams?

Nr. L'app Business Central per Teams non supporta le schede nelle riunioni.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin" />Non è possibile aggiungere una scheda se si utilizzano URL ISV come *.bc.dynamics.com (ma è possibile aggiungerle)

Non supportato.

### <a name="when-i-do-things-in-the-tab-like-navigate-resort-apply-a-filter-or-search-do-others-see-my-changes" />Quando eseguo operazioni nella scheda, come navigare, riordinare, applicare un filtro o eseguire ricerche, gli altri vedono le mie modifiche?
...
### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it" />Il contenuto della scheda si aggiorna automaticamente? In caso negativo, come posso aggiornarlo?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons" />Questo consente di visualizzaare elenchi e record dalle mie personalizzazioni e dei miei componenti aggiuntivi?

Sì. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language" />Quando aggiungo una scheda, le persone la vedranno nella mia lingua?
...
### <a name="can-i-have-multiple-tabs-pointing-to-different-content" />Posso avere più schede che puntano a contenuti diversi?

Sì.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person" />Posso anche aggiungere schede per chattare con una sola persona?
...
### <a name="can-i-switch-companies-within-a-tab" />Posso cambiare azienda all'interno di una scheda?

Nr. 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website" />È diverso dall'utilizzo della capacità generica di Teams di creare una scheda che ospita un sito Web?
...
### <a name="which-tables-does-the-app-search-in" />In quali tabelle l'app esegue la ricerca?
...
### <a name="which-fields-in-the-contacts-table-can-i-search" />In quali campi della tabella dei contatti posso eseguire la ricerca?
...
### <a name="do-search-results-include-companies-and-persons" />I risultati della ricerca includono aziende e persone?
...
### <a name="do-contacts-of-any-business-relationship-appear-in-the-results" />I contatti di una relazione d'affari compaiono nei risultati?
...
### <a name="can-i-look-up-contact-details-during-meetings" />Posso cercare i dettagli di contatto durante le riunioni?
...
### <a name="how-do-i-view-my-last-interactions-with-a-contact" />Come posso visualizzare le mie ultime interazioni con un contatto?
...
### <a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction" />Come si registra una chiamata o una riunione di Teams come interazione?
...
### <a name="can-i-call-a-contact-from-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Posso chiamare un contatto dall'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams?
...
### <a name="how-do-i-view-recent-documents-for-a-customer-or-vendor" />Come si visualizzano i documenti recenti per un cliente o un fornitore?
...
### <a name="how-do-i-search-for-contacts-using-special-characters" />Come cerco i contatti che usano caratteri speciali?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company" />Come posso cercare i contatti archiviati in un'altra azienda?
...
### <a name="are-include-prodshortmdincludesprodshortmd-contacts-different-than-the-ones-in-the-teams-contacts-screen" />I contatti [!INCLUDE [prod_short.md](includes/prod_short.md)] sono diversi da quelli nella schermata dei contatti di Teams?
...
### <a name="does-include-prodshortmdincludesprodshortmd-synchronize-contacts-with-teams" />[!INCLUDE [prod_short.md](includes/prod_short.md)] sincronizza i contatti con Teams?
...
### <a name="what-is-the-minimum-version-of-include-prodshortmdincludesprodshortmd-for-contact-search" />Qual è la versione minima di [!INCLUDE [prod_short.md](includes/prod_short.md)] per la ricerca di contatti?
...
### <a name="can-i-search-from-my-mobile-device" />Posso eseguire ricerche dal mio dispositivo mobile?

In questo momento la ricerca dei contatti non è disponibile da Teams per iOS e Teams per Android.

### <a name="which-permissions-do-i-need-for-contact-search" />Di quali autorizzazioni ho bisogno per la ricerca dei contatti?
...
### <a name="can-i-use-contact-search-if-im-a-delegated-admin" />Posso utilizzare la ricerca dei contatti se sono un amministratore delegato?
...
### <a name="is-contact-search-affected-by-api-limits" />La ricerca dei contatti è interessata dai limiti dell'API?
...
### <a name="why-does-it-sometimes-ask-me-to-set-up-the-app" />Perché a volte mi chiede di configurare l'app?
...
### <a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams" />Vorrei eseguire la ricerca di elementi o record da altre tabelle. Posso farlo da Teams?
...
### <a name="which-types-of-links-does-the-app-support" />Quali tipi di collegamento supporta l'app?
...
### <a name="how-do-i-delete-a-card-i-sent-to-a-chat" />Come elimino una scheda che ho inviato a una chat?
...
### <a name="do-cards-always-show-up-to-date-information" />Le schede mostrano sempre informazioni aggiornate?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button" />Perché le schede non mostrano più informazioni anziché solo il nome della pagina e il pulsante dei dettagli?
...
### <a name="will-others-see-my-card-if-they-dont-have-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Gli altri utenti vedranno la mia scheda se non hanno l'app [!INCLUDE [prod_short.md](includes/prod_short.md)] per Teams?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to" />Come faccio a sapere a quale società appartiene una scheda in Teams?
...
### <a name="where-is-the-save-button-in-the-details-window-in-teams" />Dov'è il pulsante Salva nella finestra dei dettagli in Teams?
...
### <a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window" />Se scelgo di visualizzare i dettagli di una scheda, gli altri utenti vedranno la finestra dei dettagli?
...
### <a name="can-i-start-a-teams-call-from-the-details-window-in-teams" />Posso avviare una chiamata Teams dalla finestra dei dettagli in Teams?
...
### <a name="can-i-print-documents-from-the-details-window-in-teams" />Posso stampare documenti dalla finestra dei dettagli in Teams?
...
### <a name="can-i-access-the-camera-from-the-details-window-in-teams" />Posso accedere alla fotocamera dalla finestra dei dettagli in Teams?
...
### <a name="a-namelocationacan-i-access-my-location-from-the-details-window-in-teams" /><a name="location"></a>Posso accedere alla mia posizione dalla finestra dei dettagli in Teams?
...
### <a name="how-do-i-open-the-details-in-a-new-window" />Come apro i dettagli in una nuova finestra?
...
### <a name="can-i-share-cards-with-users-outside-my-organization" />Posso condividere le schede con utenti esterni all'organizzazione?
...
### <a name="is-the-experience-any-different-for-users-that-are-guests" />L'esperienza è differenti per gli utenti ospiti?
...
### <a name="how-does-a-guest-user-install-the-include-prodshortmdincludesprodshortmd-app" />In che modo un utente guest installa l'app [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="does-share-to-teams-send-a-compact-card" />Condividi in Teams invia una scheda compatta?

Sì. Il collegamento si espande automaticamente in una scheda se hai installato l'app Business Central per Teams. 

### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account" />I destinatari riceveranno il messaggio da me o da un account del servizio Business Central?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises" />Condividi in Teams è disponibile in Business Central on premises?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients" />Condividi in Teams concede i permessi ai destinatari?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams" />Devo avere l'applicazione desktop Teams installata per usare Condividi in Teams?

No. Tutto ciò di cui avete bisogno è un account valido che abbia accesso a Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients" />Condividi in Teams è disponibile in tutti i clienti di Business Central?
...
### <a name="where-do-i-find-share-to-teams-in-business-central" />Dove trovo Condividi in Teams in Business Central?
