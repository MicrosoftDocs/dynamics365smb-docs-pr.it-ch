...
---
# <a name="pick-for-production-assembly-or-jobs-in-basic-warehouse-configurations" />Prelevare per produzione, assemblaggio o commesse in configurazioni di warehouse di base
...
## <a name="inventory-picks" />Prelievi magazzino
...
## <a name="inventory-movements" />Movimenti di magazzino
...
## <a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration" />Prelevare o spostare per produzione, assemblaggio e commesse in una configurazione warehouse di base
...
### <a name="to-create-an-inventory-pick-from-the-source-document" />Per creare un prelievo magazzino dal documento di origine
...
### <a name="to-create-an-inventory-movement-from-the-source-document" />Per creare un movimento di magazzino dal documento origine
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job" />Per creare più prelievi o movimenti di magazzino utilizzando un processo batch
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps" />Per creare prelievi o movimenti di magazzino in due passaggi
...
## <a name="to-record-the-inventory-pick" />Per registrare il prelievo magazzino
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration" />Consuntivazione componenti di produzione in una configurazione warehouse di base
