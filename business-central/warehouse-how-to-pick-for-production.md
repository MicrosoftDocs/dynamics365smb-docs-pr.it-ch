...
### <a name="project-management"></a>Gestione di progetti
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Prelievi magazzino** o **Movimento di magazzino**, quindi scegli il collegamento correlato.  
