...
# Visualizzare lo stato dei processi d sincronizzazione
...
## Per visualizzare e risolvere gli errori di sincronizzazione per record associati
...
## Per visualizzare il registro di sincronizzazione per uno specifico record (sincronizzato manualmente)
...
## Rimuovere associazioni tra record
