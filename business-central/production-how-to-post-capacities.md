...
ms.author: edupont
---
# <a name="post-capacities" />Registrare le capacità
...
## <a name="to-post-capacities" />Per registrare le capacità
...
## <a name="to-view-work-center-ledger-entries" />Per visualizzare i movimenti contabili relativi alle aree di produzione:
