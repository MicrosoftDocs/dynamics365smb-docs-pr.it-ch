...
ms.author: edupont
---
# <a name="post-capacities"></a><a name="post-capacities"></a>Registrare le capacità
...
## <a name="to-post-capacities"></a><a name="to-post-capacities"></a>Per registrare le capacità
...
## <a name="to-view-work-center-ledger-entries"></a><a name="to-view-work-center-ledger-entries"></a>Per visualizzare i movimenti contabili relativi alle aree di produzione:
