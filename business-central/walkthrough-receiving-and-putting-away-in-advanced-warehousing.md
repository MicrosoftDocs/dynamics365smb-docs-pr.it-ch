...
6.  Creare un ordine di acquisto per il fornitore 20000 alla data di lavoro (23 gennaio) con le righe di ordine di acquisto seguenti.  
    ...
    |Elemento|Cod. ubicazione|Quantità|  
    |----------|-------------------|--------------|  
    |70100|BIANCO|10 CAN|  
    |70101|BIANCO|12 CAN|  
