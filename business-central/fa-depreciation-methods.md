...
# <a name="depreciation-methods-for-fixed-assets"></a>Metodi di ammortamento per cespiti
...
## <a name="duplicate-entries-to-other-depreciation-books"></a>Duplicare i movimenti in altri registri beni ammortizzabili
