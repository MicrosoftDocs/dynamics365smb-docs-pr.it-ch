...
description: Se usi RapidStart Services puoi utilizzare i modelli di configurazione per strutturare i dati dei clienti esistenti prima di migrare i dati master nella nuova società in Business Central.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
