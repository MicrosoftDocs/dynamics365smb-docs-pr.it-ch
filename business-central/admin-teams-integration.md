...
> [!NOTE]
> Per impostare la distribuzione centralizzata, il tuo account Teams deve avere almeno il ruolo di [Amministratore Teams](/entra/identity/role-based-access-control/permissions-reference#teams-administrator].
