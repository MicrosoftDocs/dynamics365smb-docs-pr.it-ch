...
|Campo|Description|  
|---------------------------------|---------------------------------------|  
|**Conto utili CG realizzati**|Il conto CoGe nel quale verranno registrate i profitti del tasso di cambio per le rettifiche valutarie tra la valuta locale e la valuta contabile addizionale.|  
|**Conto perdite CG realizzate**|Il conto CoGe nel quale verranno registrate le perdite del tasso di cambio per le rettifiche valutarie tra la valuta locale e la valuta contabile addizionale.|  
...
## <a name="see-related-training-at-microsoft-learnlearnpathsuse-multiple-currencies-dynamics-365-business-central"></a>Vedere le informazioni relative al training in [Microsoft Learn](/learn/paths/use-multiple-currencies-dynamics-365-business-central/)
