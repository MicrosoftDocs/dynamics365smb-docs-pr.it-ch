...
## <a name="displaying-reports-and-amounts-in-acy"></a>Visualizzazione di report e importi nella valuta addizionale
...
## <a name="setting-up-an-acy"></a>Impostare una valuta contabile addizionale
...
### <a name="to-activate-the-acy"></a>Per attivare la valuta contabile addizionale
...
6. Compilare i campi in base alle esigenze. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]      
