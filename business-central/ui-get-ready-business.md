...
Puoi aggiungere gli utenti all'interfaccia di amministrazione Microsoft 365. Per ulteriori informazioni, vedere [Creare utenti in base alle licenze](ui-how-users-permissions.md).
...
| Impostare la posta elettronica |Consente di preparare l'invio di messaggi di posta elettronica direttamente dagli ordini di vendita o dai contatti in [!INCLUDE[prod_short](includes/prod_short.md)], ad esempio. |
...
| Impostazione dati per la creazione di report|Imposta i set di dati che è possibile utilizzare per creare report efficaci utilizzando Excel o Power BI, ad esempio. |
