...
description: Configurare Business Central in modo da poter inviare promemoria sui pagamenti dovuti e aggiungere addebiti o commissioni a causa del ritardo.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
### <a name="set-up-attachment-and-email-body-texts-for-communications"></a>Impostare i tesi degli allegati e del corpo e-mail per le comunicazioni
...
### <a name="set-up-reminder-terms"></a>Impostare i termini di sollecito

1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Termini di sollecito**, quindi scegli il collegamento correlato.  
...
3. Compilare i campi in base alle esigenze. [!INCLUDE [tooltip-inline-tip_md](includes/tooltip-inline-tip_md.md)]  
