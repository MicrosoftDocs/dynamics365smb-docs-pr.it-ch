...
# Dichiarare l'IVA all'autorità fiscale
...
## <a name="ecsaleslist"></a>Informazioni sul report Lista vendite UE
...
## <a name="vatreturn"></a>Informazioni sul report Dichiarazione IVA
...
## Per impostare i report IVA in [!INCLUDE[prod_short](includes/prod_short.md)]
