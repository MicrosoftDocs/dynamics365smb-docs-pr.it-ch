...
# Visualizzazione delle statistiche relative all'assistenza
...
## Visualizzazione delle statistiche relative a ordini di assistenza
...
### Visualizzare i totali per un ordine di assistenza  
...
### Visualizzare le informazioni di spedizione  
...
### Analizzare le righe dell'ordine di assistenza  
...
## Visualizzazione delle statistiche relative agli articoli in assistenza
...
## Visualizzazione di profitti e perdite nei contratti  
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti il nome della pagina da visualizzare, quindi scegli il collegamento correlato.  
...
## Visualizzazione di statistiche per documenti di assistenza registrati
...
### Statistiche relative alle spedizioni di assistenza registrate  
...
### Statistiche relative alle fatture di assistenza registrate  
...
### Statistiche relative alle note di credito di assistenza registrate  
