...
Utilizzare i periodi di registrazione per specificare quando l'utente può registrare nella contabilità generale.  
...
> [!NOTE]  
> Tali periodi di registrazione si applicano alla società e a tutti gli utenti. Per consentire eccezioni, è possibile definire periodi di registrazione differenziati per utenti specifici nella pagina **Setup utente**. Tali periodi di registrazione sostituiscono quelli specificati nella pagina **Setup contabilità generale**. Per ulteriori informazioni, vedi [Impostare i vincoli per gli utenti](ui-define-granular-permissions.md#set-up-time-constraints-for-users).
