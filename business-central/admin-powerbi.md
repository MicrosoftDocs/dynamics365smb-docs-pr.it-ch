...
---
# <a name="introduction-to--and-power-bi"></a><a name="introduction-to--and-power-bi"></a><a name="introduction-to--and-power-bi"></a>Introduzione a [!INCLUDE[prod_short](includes/prod_short.md)] e Power BI
...
## <a name="what-you-can-do-with-power-bi-and-"></a><a name="what-you-can-do-with-power-bi-and-"></a><a name="what-you-can-do-with-power-bi-and-"></a>Operazioni che è possibile eseguire con Power BI e [!INCLUDE[prod_short](includes/prod_short.md)]
...
<a name="onprem"><sup>*</sup></a>Questa funzione richiede un'applicazione registrata per Business Central in Microsoft Azure. Per ulteriori informazioni, vedi [Registrazione di Business Central locale in Azure AD per l'integrazione con altri servizi](/dynamics365/business-central/dev-itpro/administration/register-app-azure).

## <a name="get-ready-to-use-power-bi"></a><a name="get-ready-to-use-power-bi"></a><a name="get-ready-to-use-power-bi"></a>Preparati all'uso di Power BI
...
## <a name="track-your-business-kpis-with-power-bi-metrics"></a><a name="track-your-business-kpis-with-power-bi-metrics"></a><a name="track-your-business-kpis-with-power-bi-metrics"></a>Tieni traccia dei tuoi indicatori KPI aziendali con le metriche Power BI
...
1. Crea una scorecard nel servizio Power BI. Vedi [Creare scorecard in Power BI](/power-bi/create-reports/service-goals-create).
2. Aggiungi le _metriche_ che desideri monitorare connettendoti al tuo report Power BI sulla telemetria. Vedi [Crea metriche connesse](/power-bi/create-reports/service-goals-create-connected).
3. Per aggiungere avvisi, definisci le regole di stato per le tue metriche. Vedi [Creare regole di stato automatizzate per le metriche](/power-bi/create-reports/service-metrics-status-rules).
...
4. Infine, segui le metriche per ricevere avvisi in Teams o tramite e-mail. Vedi [Seguire le metriche](/power-bi/create-reports/service-metrics-follow).
...
> [!NOTE]
> Al momento non è possibile incorporare scorecard da metriche Power BI in [!INCLUDE[prod_short](includes/prod_short.md)].
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/configure-powerbi-excel-dynamics-365-business-central/index)
