...
---
# <a name="introduction-to--and-power-bi"></a><a name="introduction-to--and-power-bi"></a>Introduzione a [!INCLUDE[prod_short](includes/prod_short.md)] e Power BI
...
## <a name="what-you-can-do-with-power-bi-and-"></a><a name="what-you-can-do-with-power-bi-and-"></a>Operazioni che è possibile eseguire con Power BI e [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="get-ready-to-use-power-bi"></a><a name="get-ready-to-use-power-bi"></a>Preparati all'uso di Power BI
...
## <a name="track-your-business-kpis-with-power-bi-metrics"></a><a name="track-your-business-kpis-with-power-bi-metrics"></a>Tieni traccia dei tuoi indicatori KPI aziendali con le metriche Power BI
