...
## Per calcolare automaticamente l'ammortamento
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Calcola ammortamento**, quindi scegli il collegamento correlato.  
...
4. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Registrazioni cespiti in C/G**, quindi scegli il collegamento correlato.  
...
## Per registrare un ammortamento manualmente tramite Registrazioni Cespiti in C/G
...
## Per gestire il valore contabile finale
...
## Per calcolare le allocazioni nella registrazione cespiti in C/G
...
## Utilizzare le liste di duplicazione per preparare la registrazione in diversi registri beni ammortizzabili
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Registri beni ammortizzabili**, quindi scegli il collegamento correlato.  
...
## Per registrare i movimenti in diversi registri beni ammortizzabili
...
5. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Registrazioni cespiti**, quindi scegli il collegamento correlato.  
...
## Per copiare i movimenti contabili cespiti tra i registri beni ammortizzabili
