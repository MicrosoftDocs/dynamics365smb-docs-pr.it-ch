...
1. Nell'interfaccia di amministrazione di Microsoft 365, impostare un account utente per il collegamento e la sincronizzazione dei dati con [!INCLUDE[crm_md](includes/crm_md.md)]. Per ulteriori informazioni, vedere [Impostazione di account utente per l'integrazione con Dynamics 365 Sales](admin-setting-up-integration-with-dynamics-sales.md).
...
3. Impostare una connessione a [!INCLUDE[crm_md](includes/crm_md.md)]. Per ulteriori informazioni, vedere [Impostare una connessione a Dynamics 365 Sales](admin-how-to-set-up-a-dynamics-crm-connection.md).  
...
5. Sincronizzazione i dati tra le app. Per ulteriori informazioni, vedere [Sincronizzazione di Business Central e Dynamics 365 Sales](admin-synchronizing-business-central-and-sales.md).  
