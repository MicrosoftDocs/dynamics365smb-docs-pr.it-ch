---
title: Assegnare addebiti articolo a vendite e acquisti
...
# <a name="use-item-charges-to-account-for-additional-trade-costs"></a>Usare gli addebiti articolo al conto per i costi aggiuntivi commerciali
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Addebiti articoli**, quindi scegli il collegamento correlato.
...
5. Nel campo  **Quantità**, inserisci le unità dell'articolo per cui ti è stata fatturata.
