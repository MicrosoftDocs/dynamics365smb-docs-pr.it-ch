---
title: Rivedi e applica i pagamenti manualmente dopo l'applicazione automatica
...
---
# <a name="review-and-apply-payments-manually-after-automatic-application"></a>Rivedi e applica i pagamenti manualmente dopo l'applicazione automatica
...
Eventuali aggiustamenti di guadagni e perdite dovuti alle conversioni di valuta non vengono gestiti automaticamente [!INCLUDE[prod_short](includes/prod_short.md)].
...
7. Per applicare una parte di un pagamento a una o più voci aperte che non esistono nel database, creare una nuova riga sotto la riga dello stesso conto. Nel campo **Importo collegato** immettere l'importo da collegare nella nuova riga, quindi rettificare il campo **Importo collegato** nella riga esistente.
