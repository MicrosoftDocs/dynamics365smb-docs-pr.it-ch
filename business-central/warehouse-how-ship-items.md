...
# <a name="ship-items-with-a-warehouse-shipment"></a><a name="ship-items-with-a-warehouse-shipment"></a>Spedire gli articoli con una spedizione warehouse
...
## <a name="to-ship-items-using-a-warehouse-shipment-document"></a><a name="to-ship-items-using-a-warehouse-shipment-document"></a>Per spedire gli articoli usando un documento spedizione warehouse
...
## <a name="how-to-use-filters-to-get-source-documents"></a><a name="how-to-use-filters-to-get-source-documents"></a>Come utilizzare i filtri per ottenere i documenti di origine
...
## <a name="zone-and-bin-codes"></a><a name="zone-and-bin-codes"></a>Codici zona e collocazione
...
## <a name="handling-assemble-to-order-items-in-warehouse-shipments"></a><a name="handling-assemble-to-order-items-in-warehouse-shipments"></a>Gestione di articoli da assemblare su ordine in spedizioni warehouse
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/ship-invoice-items-dynamics-365-business-central/).
