...
# <a name="ship-items-with-a-warehouse-shipment" />Spedire gli articoli con una spedizione warehouse
...
## <a name="to-ship-items-using-a-warehouse-shipment-document" />Per spedire gli articoli usando un documento spedizione warehouse
...
## <a name="how-to-use-filters-to-get-source-documents" />Come utilizzare i filtri per ottenere i documenti di origine
...
## <a name="zone-and-bin-codes" />Codici zona e collocazione
...
## <a name="handling-assemble-to-order-items-in-warehouse-shipments" />Gestione di articoli da assemblare su ordine in spedizioni warehouse
...
## <a name="see-related-microsoft-trainingtrainingmodulesship-invoice-items-dynamics--business-central" />Vedi il relativo [training Microsoft](/training/modules/ship-invoice-items-dynamics-365-business-central/).
