...
5. Seleziona la relativa base di collegamento o premi CTRL+N per immettere una nuova riga, scegliere il tipo di base di collegamento, quindi inserire una descrizione.  
