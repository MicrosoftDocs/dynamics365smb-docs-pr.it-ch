...
---
# <a name="design-details-codeunit-408-dimension-management"></a><span data-ttu-id="b5f5e-103">Dettagli di progettazione: Gestione dimensioni della codeunit 408</span><span class="sxs-lookup"><span data-stu-id="b5f5e-103">Design Details: Codeunit 408 Dimension Management</span></span>
<span data-ttu-id="b5f5e-104">La gestione delle dimensioni della Codeunit 408 è una libreria di funzione che gestisce le attività comuni correlate alle dimensioni, ad esempio copia da una tabella a un'altra oppure da un documento a un altro.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-104">Codeunit 408 Dimension Management is a function library that handles common tasks that are related to dimensions, such as copying from one table to another or from one document to another.</span></span> <span data-ttu-id="b5f5e-105">In questo argomento sono elencate le funzioni che vengono modificate in Microsoft Dynamics NAV 2013 R2 e vengono specificate le azioni da intraprendere per le funzioni.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-105">This topic lists the functions that are modified in Microsoft Dynamics NAV 2013 R2 and specifies what has to be done to the functions.</span></span> <span data-ttu-id="b5f5e-106">Numerose funzioni sono state eliminate in quanto non è necessario eseguire copie tra le tabelle delle dimensioni.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-106">Many functions are deleted because there is no need for copying between dimension tables.</span></span>  

## <a name="modified-functions"></a><span data-ttu-id="b5f5e-107">Funzioni modificate</span><span class="sxs-lookup"><span data-stu-id="b5f5e-107">Modified Functions</span></span>  

|<span data-ttu-id="b5f5e-108">Nome funzione</span><span class="sxs-lookup"><span data-stu-id="b5f5e-108">Function Name</span></span>|<span data-ttu-id="b5f5e-109">Descrizione modifica</span><span class="sxs-lookup"><span data-stu-id="b5f5e-109">Modification Description</span></span>|  
|-------------------|------------------------------|  
|<span data-ttu-id="b5f5e-110">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="b5f5e-110">CheckDimSetIDComb</span></span>|<span data-ttu-id="b5f5e-111">Nuova funzione che sostituisce le altre funzioni di controllo e accetta un ID di set di dimensioni come argomento anziché una tabella delle dimensioni.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-111">New function that substitutes the other check functions and takes a Dimension Set ID as an argument instead of a dimension table.</span></span>|  
|<span data-ttu-id="b5f5e-112">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="b5f5e-112">CheckDimSetIDComb</span></span><br /><br /> <span data-ttu-id="b5f5e-113">CheckDocDimComb</span><span class="sxs-lookup"><span data-stu-id="b5f5e-113">CheckDocDimComb</span></span><br /><br /> <span data-ttu-id="b5f5e-114">CheckServContractDimComb</span><span class="sxs-lookup"><span data-stu-id="b5f5e-114">CheckServContractDimComb</span></span><br /><br /> <span data-ttu-id="b5f5e-115">CheckDimBuffer</span><span class="sxs-lookup"><span data-stu-id="b5f5e-115">CheckDimBuffer</span></span><br /><br /> <span data-ttu-id="b5f5e-116">CheckDimComb</span><span class="sxs-lookup"><span data-stu-id="b5f5e-116">CheckDimComb</span></span><br /><br /> <span data-ttu-id="b5f5e-117">CheckDimValueComb</span><span class="sxs-lookup"><span data-stu-id="b5f5e-117">CheckDimValueComb</span></span>|<span data-ttu-id="b5f5e-118">Elimina.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-118">Delete.</span></span> <span data-ttu-id="b5f5e-119">Tutti gli utilizzi devono essere modificati in CheckDimSetIDComb.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-119">All usage should be changed to CheckDimSetIDComb.</span></span>|  
|<span data-ttu-id="b5f5e-120">GetDefaultDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-120">GetDefaultDim</span></span>|<span data-ttu-id="b5f5e-121">Modificare per restituire un ID di set di dimensioni sotto forma di valore intero anziché un set di record.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-121">Modify to return an integer Dimension Set ID instead of a set of records.</span></span>|  
|<span data-ttu-id="b5f5e-122">CopyJnlLineDimToICJnlDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-122">CopyJnlLineDimToICJnlDim</span></span><br /><br /> <span data-ttu-id="b5f5e-123">CopyICJnlDimToJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-123">CopyICJnlDimToJnlLineDim</span></span><br /><br /> <span data-ttu-id="b5f5e-124">CopyDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-124">CopyDocDimtoICDocDim</span></span><br /><br /> <span data-ttu-id="b5f5e-125">CopyICDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-125">CopyICDocDimtoICDocDim</span></span>|<span data-ttu-id="b5f5e-126">Modificare per utilizzare DimSetID -> ICJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-126">Modify to work with DimSetID -> ICJnlLineDim</span></span>|  

## <a name="deleted-functions"></a><span data-ttu-id="b5f5e-127">Funzioni eliminate</span><span class="sxs-lookup"><span data-stu-id="b5f5e-127">Deleted Functions</span></span>  
...
>  <span data-ttu-id="b5f5e-129">Durante l'aggiornamento del codice dell'applicazione da Microsoft Dynamics NAV 2009 o versioni precedenti a Microsoft Dynamics NAV 2016, le seguenti funzioni non sono disponibili in Microsoft Dynamics NAV 2016.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-129">During the upgrade of application code from Microsoft Dynamics NAV 2009 or earlier versions to Microsoft Dynamics NAV 2016, the following functions are not available in Microsoft Dynamics NAV 2016.</span></span> <span data-ttu-id="b5f5e-130">Se si dispone di personalizzazioni in cui vengono utilizzate una o più funzioni, è necessario aggiornare il codice di conseguenza.</span><span class="sxs-lookup"><span data-stu-id="b5f5e-130">If you have customizations that use one or more of the functions, you must upgrade that code accordingly.</span></span>
 ...
 <span data-ttu-id="b5f5e-144">GetDocDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-144">GetDocDim</span></span>  
 ...
 <span data-ttu-id="b5f5e-164">ShowTempDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-164">ShowTempDim</span></span>  
 ...
 <span data-ttu-id="b5f5e-184">CopySCDimToDocDim</span><span class="sxs-lookup"><span data-stu-id="b5f5e-184">CopySCDimToDocDim</span></span>  
 ...
 <span data-ttu-id="b5f5e-205">CopyJnlLineDimToBuffer</span><span class="sxs-lookup"><span data-stu-id="b5f5e-205">CopyJnlLineDimToBuffer</span></span>  
