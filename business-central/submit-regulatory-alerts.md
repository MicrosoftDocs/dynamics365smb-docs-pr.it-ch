...
1. Andare a https://lcs.dynamics.com ed effettuare l'accesso. Verranno visualizzati i progetti a cui si ha accesso.

2. Selezionare il progetto **Avvisi normativi - In tutto il mondo**. Il progetto viene aperto e vengono visualizzati vari elementi correlati al progetto.

3. Selezionare **Servizio avviso** nella parte destra della sezione **Altri strumenti**. Verrà visualizzato un elenco di avvisi con il titolo **Invio avviso normativo Dynamics**.

4. È possibile aggiungere un nuovo avviso facendo clic sul segno **(+)** nella parte superiore dell'elenco. In tal caso, viene visualizzata una guida con 4 passaggi per creare l'avviso. I passaggi della guida sono:
