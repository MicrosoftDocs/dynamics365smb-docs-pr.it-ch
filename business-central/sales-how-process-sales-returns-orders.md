...
---
# <a name="process-sales-return-orders"></a>Elaborare gli ordini di reso vendita
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Ordini reso vendita**, quindi scegli il collegamento correlato.
