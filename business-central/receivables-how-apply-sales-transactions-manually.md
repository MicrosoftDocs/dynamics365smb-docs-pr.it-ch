...
---
# <a name="reconcile-customer-payments-with-a-cash-receipt-journal-or-from-customer-ledger-entries"></a>Riconciliare i pagamenti dei clienti con un giornale di registrazione delle ricevute di cassa o dai movimenti contabili dei clienti
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") , immettere **Registro incassi** e scegliere il collegamento correlato.
2. Scegliere l'azione **Modifica registrazione**.
...
5. Scegliere il pulsante **OK**. La pagina  **Nota credito vendita** mostra ora la voce selezionata nella sezione **Applica-a doc. Digita** e **Applica-a doc. N.** campi. e l'importo della nota di credito da registrare, rettificato per eventuali sconti di pagamenti.
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Registrazione incassi**, quindi scegli il collegamento correlato.
