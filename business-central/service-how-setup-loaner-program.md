...
---
# Impostazione di un programma di prestito articoli
...
## Per impostare un articolo in prestito  
...
3. Nel campo **Nr.** inserire un numero per l'articolo in prestito. In alternativa, se hai impostato una numerazione per gli articoli in prestito nella pagina **Setup gest. assist.**, puoi selezionare <kbd>INVIO</kbd> per inserire il successivo numero di articolo in prestito disponibile.  
