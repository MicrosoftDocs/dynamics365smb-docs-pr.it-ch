...
1. Scegli la ![lampadina che apre la funzione Dimmi 10](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire"). immettere **Ordini vendita**, quindi selezionare il collegamento correlato.
...
## <a name="create-a-sales-invoice"></a>Crea una fattura di vendita
...
1. Scegli la ![lampadina che apre la funzione Dimmi 20](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire"). immetti **Fatture vendite**, quindi seleziona il collegamento correlato.  
