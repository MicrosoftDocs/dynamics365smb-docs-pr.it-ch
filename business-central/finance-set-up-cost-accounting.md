...
|A|Vedere|  
|--------|---------|  
|Creare il piano dei tipi di costo.|[Setup tipi di costo](finance-how-to-set-up-cost-types.md)|  
...
|Creare il grafico dei centri di costo.|[Impostare i centri di costo](finance-how-to-set-up-cost-centers.md)|  
|Creare il grafico degli oggetti di costo.|[Impostare gli oggetti di costo](finance-how-to-set-up-cost-objects.md)|  
