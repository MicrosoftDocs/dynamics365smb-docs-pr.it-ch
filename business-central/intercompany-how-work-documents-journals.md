...
---
# <a name="work-with-intercompany-documents-and-journals" />Utilizzo di documenti e registrazioni intercompany
...
## <a name="fill-in-and-send-an-intercompany-sales-order" />Compilare e inviare un ordine di vendita intercompany
...
## <a name="fill-in-and-post-an-intercompany-journal" />Compilare e contabilizzare le registrazioni intercompany
