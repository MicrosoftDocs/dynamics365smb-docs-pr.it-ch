...
# <a name="walkthrough-use-order-planning-to-create-and-reserve-supply" />Procedura dettagliata: Utilizzare la pianificazione degli ordini per creare e prenotare la fornitura
