...
3. Crea l'ordine di acquisto, che è il tipo più comune di documenti origine in entrata.  
    ...
    |Elemento|Cod. ubicazione|Codice collocazione|Quantità|  
    |----------|----------|---------|--------------|  
...
5. Modificare lo stoccaggio in magazzino in base al posizionamento effettivo degli articoli e al documento di registrazione
    ...
    2.  Immetti 20 nel campo **Qtà. da gestire** nella riga di stoccaggio magazzino con l'articolo WRB-1000.  
    ...
    4. Compila i codici collocazione per l'articolo WRB-1001:

    |Elemento|Codice collocazione|Quantità|  
    |----------|-------------------|--------------|  
    |WRB-1001|S-1-03|20|  
    |WRB-1001|S-1-04|10|
...
2. Crea l'ordine di vendita, che è il tipo più comune di documenti origine in uscita.  
    ...
    1. Scegli l'icona ![lampadina che apre la funzione Dimmi 6.](../../media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immettere **Ordini vendita**, quindi selezionare il collegamento correlato.  
    2. Scegliere l'azione **Nuovo**.  
    3. Crea un ordine di vendita per il cliente 10000 con la seguente riga ordine di vendita.  

    |Elemento|Codice ubicazione|Quantità|  
    |----|-------------|--------|  
    |WRB-1000|ARGENTO|20|  
    |WRB-1001|ARGENTO|30|  
    ...
    6. Scegliere il pulsante **OK**. Verrà creato un nuovo prelievo magazzino.
