...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a><a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a><a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a>Procedura dettagliata del flusso in entrata e in uscita nelle configurazioni di warehouse miste
...
## <a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations"></a><a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations"></a><a name="inbound-flow-receiving-and-putting-away-in-basic-warehouse-configurations"></a>Flusso in entrata: ricezione e stoccaggio nelle configurazioni di warehouse di base
...
### <a name="results"></a><a name="results"></a><a name="results"></a>Risultati
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a><a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a><a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a>Flusso in uscita: prelievo e spedizione nelle configurazioni di warehouse avanzate
...
### <a name="steps-1"></a><a name="steps-1"></a><a name="steps-1"></a>Passaggi
...
### <a name="results-1"></a><a name="results-1"></a><a name="results-1"></a>Risultati
