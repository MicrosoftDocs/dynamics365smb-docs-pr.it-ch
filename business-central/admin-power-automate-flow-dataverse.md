...
---
# <a name="use-a-power-automate-flow-to-timely-synchronize-dataverse-entity-changes"></a>Utilizzare un flusso Power Automate per sincronizzare tempestivamente le modifiche alle entità Dataverse
