...
ms.author: edupont
---
# <a name="change-which-features-are-displayed" />Modifica delle funzionalità visualizzate
...
## <a name="enabling-premium-features-after-upgrading-a-plan" />Abilitazione delle funzioni Premium dopo l'aggiornamento di un piano
...
### <a name="to-update-plan-changes-in-users-groups" />Per aggiornare le modifiche di piano in gruppi di utenti
...
### <a name="to-select-the-premium-experience" />Per selezionare l'esperienza Premium
...
## <a name="help-assumes-premium-experience" />La Guida presuppone un'esperienza Premium
