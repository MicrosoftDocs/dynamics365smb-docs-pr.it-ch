...
---
# Registrare i consumi e l'output relativi a una singola riga dell'ordine di produzione rilasciato
...
## Per registrare consumi e output  

1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Ordini di produzione rilasciati**, quindi scegli il collegamento correlato.  
