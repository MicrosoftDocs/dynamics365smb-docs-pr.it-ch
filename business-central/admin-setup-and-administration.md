...
|Immettere richieste singole o ricorrenti per eseguire report o codeunit.|[Usare le code processi per pianificare le attività](admin-job-queues-schedule-tasks.md)|  
...
|Crittografare i dati in [!INCLUDE[prod_short](includes/prod_short.md)] Server generando nuove chiavi di crittografia o importando quelle esistenti che vengono abilitate nel server.|[Gestire la crittografia dei dati](admin-manage-data-encryption.md)|
