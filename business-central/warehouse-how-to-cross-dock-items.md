...
1. Se usi le collocazioni, imposta almeno una collocazione di cross-dock. Se utilizzi stoccaggi e prelievi diretti, configura una zona di cross-dock.  
    ...
    Per una collocazione del cross-dock è selezionato il campo **Collocazione cross-dock**. Per ulteriori informazioni sui contenitori, vai a [Crea collocazioni](warehouse-how-to-create-individual-bins.md).  

    Se si utilizzano le zone, creare una zona per le collocazioni cross-dock e selezionare il campo **Zona collocazione cross-dock**. Se si utilizzano stoccaggi e prelievi guidati, seleziona il tipo di collocazione con **Prelievo** selezionato, ad esempio è possibile utilizzare *PICK* o *PUTPICK*. Per ulteriori informazioni sulle zone e sui tipi di collocazioni, vai a [Impostazione delle posizioni per l'utilizzo delle collocazioni](warehouse-how-to-set-up-locations-to-use-bins.md) e [Impostazione dei tipi di collocazioni](warehouse-how-to-set-up-bin-types.md).  

2. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Ubicazione**, quindi scegli il collegamento correlato.  
...
6. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Unità di stockkeeping**, quindi scegli il collegamento correlato.  
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Carichi warehouse**, quindi seleziona il collegamento correlato.  
...
1. Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Carichi warehouse**, quindi seleziona il collegamento correlato.  
