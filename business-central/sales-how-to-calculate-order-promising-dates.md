...
---
# Calcolare le date per la promessa ordine
...
## Informazioni sulla promessa ordine
...
## Per impostare le promesse ordine

1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Setup promessa ordine**, quindi scegli il collegamento correlato.  
...
### Tempo di gestione della warehouse in entrata e in uscita nella promessa ordine
...
#### Per immettere il tempo di gestione della warehouse in entrata e in uscita predefinito per i documenti di vendita e acquisto
...
#### Per immettere i tempi di gestione warehouse in entrata e in uscita nelle ubicazioni
...
## Per identificare un articolo come critico
...
## Per calcolare una data per la promessa ordine

1.  Scegli l'icona ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Ordine vendita**, quindi seleziona il collegamento correlato.  
