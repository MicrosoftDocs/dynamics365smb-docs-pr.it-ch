...
### <a name="to-map-columns-in-the-data-file-to-fields-in-prod_short"></a><a name=mapfields></a>Per eseguire il mapping delle colonne del file di dati nei campi in [!INCLUDE[prod_short](includes/prod_short.md)]
