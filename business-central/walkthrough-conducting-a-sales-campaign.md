...
## <a name="setting-up-a-campaign"></a>Impostazione di una campagna
...
1. Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Campagne**, quindi scegli il collegamento correlato.  
...
### <a name="to-save-your-segmentation-criteria"></a>Per salvare i criteri di segmentazione
...
### <a name="to-bring-back-the-removed-contacts"></a>Per riportare i contatti rimossi
...
Scegli la ![lampadina che apre la funzione Dimmi.](media/ui-search/search_small.png "Informazioni sull'operazione che si desidera eseguire") immetti **Movimenti log interazione**, quindi scegli il collegamento correlato. È presente un movimento per ciascuna lettera inviata.  
...
## <a name="register-campaign-responses"></a>Registrare le risposte alla campagna
