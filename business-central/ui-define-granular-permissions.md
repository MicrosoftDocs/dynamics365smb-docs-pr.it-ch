...
# <a name="assign-permissions-to-users-and-groups" />Assegnare autorizzazioni a utenti e gruppi
...
## <a name="to-create-a-permission-set" />Per creare un set di autorizzazioni
...
### <a name="example---indirect-permission" />Esempio - Autorizzazione indiretta
...
### <a name="to-add-other-permission-sets" />Per aggiungere altri set di autorizzazioni
...
## <a name="to-copy-a-permission-set" />Per copiare un set di autorizzazioni
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Per creare o modificare le autorizzazioni registrando le azioni
...
### <a name="to-export-and-import-a-permission-set" />Per esportare e importare un set di autorizzazioni
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Per rimuovere le autorizzazioni obsolete da tutti i set di autorizzazioni

Nella pagina **Set di autorizzazioni**, scegliere l'azione **Rimuovi autorizzazioni obsolete**.

## <a name="to-set-up-time-constraints-for-users" />Per impostare i vincoli di tempo per gli utenti
...
## <a name="to-manage-permissions-through-user-groups" />Per gestire le autorizzazioni tramite gruppi di utenti
...
### <a name="to-add-users-to-a-user-group" />Per aggiungere utenti a un gruppo di utenti
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Per copiare un gruppo di utenti e tutti i suoi set di autorizzazioni
...
### <a name="to-assign-permission-sets-to-user-groups" />Per assegnare i set di autorizzazioni a gruppi utente
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Per assegnare un set di autorizzazioni nella pagina **Set di autorizzazioni per gruppo di utenti**
...
## <a name="to-assign-permission-sets-to-users" />Per assegnare set di autorizzazioni agli utenti
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Per assegnare un set di autorizzazioni in una scheda utente
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Per assegnare un set di autorizzazioni nella pagina Set di autorizzazioni per utente
...
## <a name="to-get-an-overview-of-a-users-permissions" />Per ottenere una sintesi delle autorizzazioni di un utente:
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Filtri di sicurezza per limitare l'accesso di un utente a record specifici in una tabella
...
## <a name="viewing-permission-changes-telemetry" />Visualizzazione della telemetria sulle modifiche delle autorizzazioni
...
## <a name="delegated-admin-users" />Utenti amministratori con delega
