...
# <a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a>Assegnare autorizzazioni a utenti e gruppi
...
## <a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a>Per creare un set di autorizzazioni
...
### <a name="example---indirect-permission"></a><a name="example---indirect-permission"></a><a name="example---indirect-permission"></a>Esempio - Autorizzazione indiretta
...
### <a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a>Per aggiungere altri set di autorizzazioni
...
## <a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a>Per copiare un set di autorizzazioni
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a>Per creare o modificare le autorizzazioni registrando le azioni
...
### <a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a>Per esportare e importare un set di autorizzazioni
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a>Per rimuovere le autorizzazioni obsolete da tutti i set di autorizzazioni

Nella pagina **Set di autorizzazioni**, scegliere l'azione **Rimuovi autorizzazioni obsolete**.

## <a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a>Per impostare i vincoli di tempo per gli utenti
...
## <a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a>Per gestire le autorizzazioni tramite gruppi di utenti
...
### <a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a>Per aggiungere utenti a un gruppo di utenti
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a>Per copiare un gruppo di utenti e tutti i suoi set di autorizzazioni
...
### <a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a>Per assegnare i set di autorizzazioni a gruppi utente
...
## <a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a>Per assegnare set di autorizzazioni agli utenti
...
### <a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a>Per assegnare un set di autorizzazioni in una scheda utente
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a>Per assegnare un set di autorizzazioni nella pagina Set di autorizzazioni per utente
...
## <a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a>Per ottenere una sintesi delle autorizzazioni di un utente:
...
## <a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a>Visualizzazione della telemetria sulle modifiche delle autorizzazioni
...
## <a name="delegated-admin-users"></a><a name="delegated-admin-users"></a><a name="delegated-admin-users"></a>Utenti amministratori con delega
