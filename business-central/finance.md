---
title: Gestione finanziaria (contiene Video)
...
## <a name="get-started-with-finance-capabilities"></a>Iniziare con le funzionalità finanziarie
...
## <a name="financial-analytics"></a>Analisi finanziaria
...
| Per... | Vedere |
| --- | --- |
| Scopri le funzionalità per l'analisi dei dati finanziari. | [Panoramica di Analisi finanziaria](bi.md) |
| Configurare la creaazione di report finanziari in business unit o persone giuridiche. | [Gestione dei report finanziari in business unit o persone giuridiche](finance-consolidated-company-reporting.md) |
| Configurare e utilizzare la creazione di report finanziari per produrre rendiconti finanziari e indicatori generali. | [Preparare il reporting finanziario](bi-how-work-account-schedule.md) |
| Esegui analisi ad hoc dei dati finanziari direttamente nelle pagine di elenco e nelle query. | [Analisi ad hoc sui dati finanziari](ad-hoc-analysis-finance.md) |
| Analizza i dati finanziari dal piano dei conti. | [Analizzare i dati finanziari dal piano dei conti](finance-general-ledger.md) |
| Analizza gli importi effettivi e degli importi di budget | [Analizzare gli importi effettivi e gli importi budget](bi-how-analyze-actual-versus-budget.md) |
| Analizza il flusso di cassa. | [Analizzare il flusso di cassa](finance-analyze-cash-flow.md) |
| Esplora report finanziari chiave integrati. | [Report finanziari chiave predefiniti](finance-reports.md) |
| Esplora report integrati chiave sui cespiti. | [Report sui cespiti predefiniti](fa-reports.md) |
| Esplora report di contabilità clienti chiave integrati. | [Report di contabilità clienti predefiniti](receivables-reports.md)
| Esplora report di contabilità fornitori predefiniti. | [Report di contabilità fornitori predefiniti](payables-reports.md)

## <a name="vat-and-taxes"></a>IVA e tasse
...
| Per... | Vedere |
| --- | --- |
|Calcola l'imposta sul valore aggiunto (VAT) sulle transazioni di vendita e acquisto in modo da segnalare gli importi alle autorità fiscali.|[Usare l'IVA nelle vendite e negli acquisti](finance-work-with-vat.md)|
...
## <a name="manage-receivables-and-payables"></a>Gestire crediti e debiti
...
## <a name="manage-multiple-companies"></a>Gestire più società
...
## <a name="period-end-reporting-and-related-tasks"></a>Creazione di report di fine periodo e attività correlate
...
## <a name="managerial-accounting"></a>Contabilità gestionale
...
## <a name="free-e-learning-modules"></a>Moduli di e-learning gratuiti
