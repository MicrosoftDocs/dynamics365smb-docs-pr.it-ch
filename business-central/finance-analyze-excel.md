...
## Visualizzazione di una panoramica e dei dettagli in Excel
...
|Scadenzario fornitori         | Addetto contabile |
|Scadenzario clienti      | Addetto contabile |
...
### Comprendere i modelli di Excel
...
## Componente aggiuntivo per Excel [!INCLUDE [prod_short](includes/prod_short.md)]
