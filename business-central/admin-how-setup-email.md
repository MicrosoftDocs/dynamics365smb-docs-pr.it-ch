...
# <a name="set-up-email" />Configurare la posta elettronica
...
## <a name="adding-email-accounts" />Aggiunta di account di posta elettronica
...
## <a name="using-smtp" />Utilizzo di SMTP
...
## <a name="add-email-accounts" />Aggiungere account di posta elettronica
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts" />Assegnare scenari di posta elettronica ad account di posta elettronica
...
## <a name="set-up-view-policies" />Impostare i criteri di visualizzazione
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute" />Specificare quanti messaggi un account può inviare al minuto
...
## <a name="set-up-reusable-email-texts-and-layouts" />Impostare testi e-mail riutilizzabili e layout
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Utilizzare un indirizzo mittente sostitutivo nei messaggi di posta elettronica in uscita
...
## <a name="set-up-document-sending-profiles" />Impostare profili di invio documenti
...
## <a name="optional-set-up-email-logging-in-exchange-online" />Facltativo: Impostare il log delle e-mail in Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />Configurazione della posta elettronica per Business Central locale
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal" />Creare una registrazione dell'app per Business Central nel portale di Azure
