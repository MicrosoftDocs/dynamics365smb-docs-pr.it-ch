...
# <a name="set-up-email"></a><a name="set-up-email"></a>Configurare la posta elettronica
...
## <a name="adding-email-accounts"></a><a name="adding-email-accounts"></a>Aggiunta di account di posta elettronica
...
## <a name="using-smtp"></a><a name="using-smtp"></a>Utilizzo di SMTP
...
## <a name="add-email-accounts"></a><a name="add-email-accounts"></a>Aggiungere account di posta elettronica
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a>Assegnare scenari di posta elettronica ad account di posta elettronica
...
## <a name="set-up-view-policies"></a><a name="set-up-view-policies"></a>Impostare i criteri di visualizzazione
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a>Specificare quanti messaggi un account può inviare al minuto
...
## <a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a>Impostare testi e-mail riutilizzabili e layout
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a>Utilizzare un indirizzo mittente sostitutivo nei messaggi di posta elettronica in uscita
...
## <a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a>Impostare profili di invio documenti
...
## <a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a>Facltativo: Impostare il log delle e-mail in Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a>Configurazione della posta elettronica per Business Central locale
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a>Creare una registrazione dell'app per Business Central nel portale di Azure
...
### <a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a>Connettere l'app [!INCLUDE[prod_short](includes/prod_short.md)] alla registrazione dell'app
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Vedi il relativo [training Microsoft](/training/modules/set-up-email/)
