...
### <a name="item-ledger-entries-1"></a>Movimenti contabili articoli (1)

|Data di Registrazione|Tipo di movimento|Importo costo (effettivo)|Quantità|Nr. Movimento|  
|------------|----------|--------------------|--------|---------|  
|01-01-20|Acquisti|80.00|10|1|  

### <a name="value-entries-1"></a>Movimenti di valorizzazione (1)

|Data di Registrazione|Tipo di movimento|Importo costo (effettivo)|Nr. movimento cont. articolo|Nr. movimento|  
|------------|----------|--------------------|---------------------|---------|  
|01-01-20|Costo Diretto|70.00|1|1|  
|01-01-20|Costi indiretti|10.00|1|2|  

### <a name="item-application-entries-1"></a>Movimenti di collegamento articoli (1)
...
### <a name="item-ledger-entries-2"></a>Movimenti contabili articoli (2)

|Data di Registrazione|Tipo di movimento|Importo costo (effettivo)|Quantità|Nr. Movimento|  
|------------|----------|--------------------|--------|---------|  
|01-15-20|Vendita|-80,00|-10|2|  
...
### <a name="item-application-entries-2"></a>Movimenti di collegamento articoli (2)
...
### <a name="value-entries-3"></a>Movimenti di valorizzazione (3)

|Data di Registrazione|Tipo di movimento|Importo costo (effettivo)|Costo registrato in C/G|Nr. movimento cont. articolo|Nr. movimento|  
|------------|----------|--------------------|------------------|---------------------|---------|  
|01-01-20|Costo Diretto|70.00|70.00|1|1|  
|01-01-20|Costo Indiretto|10,00|10,00|1|2|  
|01-15-20|Costo diretto|-80,00|-80,00|2|3|  

### <a name="general-ledger-entries-3"></a>Movimenti C/G (3)

|Data di Registrazione|Conto C/G|Numero di conto (demo en-US)|Importo|Nr. Movimento|  
|------------|-----------|------------------------|------|---------|  
