...
---
# <a name="add-clients-to-your-dashboard-in-included365acclongincludesd365acclongmdmd"></a>Aggiungere clienti al dashboard in [!INCLUDE[d365acc_long](includes/d365acc_long_md.md)]
...
Una società che utilizza [!INCLUDE[d365fin](includes/d365fin_md.md)] può invitare un utente a [!INCLUDE[d365fin](includes/d365fin_md.md)] come contabile esterno. Per ricevere l'invito, è necessario fornire il messaggio e-mail usato con [!INCLUDE[d365acc](includes/d365acc_md.md)], ad esempio *me@accountant.com*. L'amministratore del cliente può quindi aggiungerti al sistema eseguendo la procedura guidata **Invita contabile esterno**.  
